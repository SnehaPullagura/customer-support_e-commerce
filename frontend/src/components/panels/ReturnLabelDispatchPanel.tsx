...
interface ReturnLabelDispatchPanelProps {
  title?: string;
  onRefresh?: () => void;
}

export const ReturnLabelDispatchPanel: React.FC<ReturnLabelDispatchPanelProps> = ({
  title = "Prepaid Return Shipping Label Dispatch Stream",
  onRefresh,
}) => {
    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Live queue of generated RMA return labels and courier tracking numbers.</p>
        </div>
        <button
