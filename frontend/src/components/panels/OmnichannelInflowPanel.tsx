...
interface OmnichannelInflowPanelProps {
  title?: string;
  onRefresh?: () => void;
}

export const OmnichannelInflowPanel: React.FC<OmnichannelInflowPanelProps> = ({
  title = "Multi-Channel Ticket Inflow & Routing Panel",
  onRefresh,
}) => {
    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Displays incoming message velocity across Email, SMS, WhatsApp, and Voice.</p>
        </div>
        <button
