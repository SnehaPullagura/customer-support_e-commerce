...
interface CSATSatisfactionHeatmapProps {
  title?: string;
  onRefresh?: () => void;
}

export const CSATSatisfactionHeatmap: React.FC<CSATSatisfactionHeatmapProps> = ({
  title = "Post-Resolution CSAT Satisfaction Heatmap",
  onRefresh,
}) => {
    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Geographic and department heatmap of 5-star customer feedback.</p>
        </div>
        <button
