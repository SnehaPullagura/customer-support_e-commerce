...
interface BulkActionDispatcherProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const BulkActionDispatcher: React.FC<BulkActionDispatcherProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Batch Ticket Bulk Action & Tag Dispatcher</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Batch assignment, status transition, and mass email broadcaster for outages.</p>
        </div>
