...
interface VoiceCallAssistantDrawerProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const VoiceCallAssistantDrawer: React.FC<VoiceCallAssistantDrawerProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">AI Real-Time Voice Call Co-Pilot Drawer</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Speech transcription stream with suggested resolution responses and live sentiment.</p>
        </div>
