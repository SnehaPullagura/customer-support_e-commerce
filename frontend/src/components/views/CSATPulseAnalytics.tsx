...
interface CSATPulseAnalyticsProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const CSATPulseAnalytics: React.FC<CSATPulseAnalyticsProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Post-Interaction CSAT & Net Promoter Dashboard</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Customer satisfaction scores aggregated by department, agent, and issue category.</p>
        </div>
