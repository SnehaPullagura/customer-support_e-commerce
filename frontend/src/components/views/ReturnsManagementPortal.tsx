...
interface ReturnsManagementPortalProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const ReturnsManagementPortal: React.FC<ReturnsManagementPortalProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Customer Self-Service RMA & Label Portal</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Multi-step return wizard allowing customer photo upload and dropoff selection.</p>
        </div>
