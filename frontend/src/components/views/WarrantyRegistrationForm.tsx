      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Serialized Product Warranty Registration Form</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">IMEI / Serial lookup with extended apple care / protection plan upsell.</p>
        </div>
