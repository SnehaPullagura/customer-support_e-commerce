...
interface DisputeCaseManagerProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const DisputeCaseManager: React.FC<DisputeCaseManagerProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Chargeback Dispute Dossier & Evidence Manager</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Complete evidence bundle builder with Stripe / PayPal direct submission.</p>
        </div>
