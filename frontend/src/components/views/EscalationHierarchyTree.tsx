...
interface EscalationHierarchyTreeProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const EscalationHierarchyTree: React.FC<EscalationHierarchyTreeProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Tier 1 / Tier 2 / Tier 3 Escalation Tree</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Visual org chart showing on-call supervisors and escalation dispatch buttons.</p>
        </div>
