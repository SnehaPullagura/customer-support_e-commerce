...
interface OmnichannelChatWidgetProps {
  initialData?: any;
  onRefresh?: () => void;
}

export const OmnichannelChatWidget: React.FC<OmnichannelChatWidgetProps> = ({
  initialData,
  onRefresh,
}) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-extrabold text-slate-900 tracking-tight">Omnichannel Live Customer Chat & AI Copilot</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Integrated chat terminal with real-time intent extraction and canned response inserts.</p>
        </div>
