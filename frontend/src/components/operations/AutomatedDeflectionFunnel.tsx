...
interface AutomatedDeflectionFunnelProps {
  title?: string;
  data?: any;
  onAction?: (payload: any) => void;
}

export const AutomatedDeflectionFunnel: React.FC<AutomatedDeflectionFunnelProps> = ({
  title = "AI Self-Service Deflection Funnel Chart",
  data,
  onAction,
}) => {
    ...
    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Step-by-step funnel measuring customer issue deflection before agent handoff.</p>
        </div>
