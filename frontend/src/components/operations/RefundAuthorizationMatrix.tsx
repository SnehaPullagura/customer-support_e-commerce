...
interface RefundAuthorizationMatrixProps {
  title?: string;
  data?: any;
  onAction?: (payload: any) => void;
}

export const RefundAuthorizationMatrix: React.FC<RefundAuthorizationMatrixProps> = ({
  title = "Multi-Tier Financial Approval Workflow",
  data,
  onAction,
}) => {
    ...
    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Hierarchical sign-off queue for refunds exceeding team lead $250.00 limits.</p>
        </div>
