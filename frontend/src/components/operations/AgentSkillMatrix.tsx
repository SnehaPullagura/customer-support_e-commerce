...
export const AgentSkillMatrix: React.FC<AgentSkillMatrixProps> = ({
  title = "Agent Skill & Language Proficiency Table",
  data,
  onAction,
}) => {
    ...
    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Dynamic assignment routing matrix linking customer languages to qualified tiers.</p>
        </div>
