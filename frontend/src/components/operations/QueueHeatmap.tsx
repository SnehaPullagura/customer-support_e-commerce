...
export const QueueHeatmap: React.FC<QueueHeatmapProps> = ({
  title = "Queue Load & Agent Allocation Heatmap",
  data,
  onAction,
}) => {
    ...
    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Interactive hourly volume matrix showing ticket intake surges by timezone.</p>
        </div>
