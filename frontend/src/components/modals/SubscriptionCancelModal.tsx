...
export const SubscriptionCancelModal: React.FC<SubscriptionCancelModalProps> = ({
  ...
  onClose,
  onSubmit,
  title = "Recurring Membership Cancellation & Credit",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Cancels auto-renewing subscription and issues prorated refund.</p>
          </div>
          {onClose && (
