...
interface ApparelExchangeModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const ApparelExchangeModal: React.FC<ApparelExchangeModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Apparel Size & Color Instant Exchange",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Authorizes instantaneous size swap before customer drops off return package.</p>
          </div>
          {onClose && (
