...
export const DiscountOverrideModal: React.FC<DiscountOverrideModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Supervisor Goodwill Discount Authorization",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Allows supervisor to issue custom courtesy discount code up to $50.00.</p>
          </div>
          {onClose && (
