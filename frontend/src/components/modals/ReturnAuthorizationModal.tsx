...
interface ReturnAuthorizationModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const ReturnAuthorizationModal: React.FC<ReturnAuthorizationModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Authorize RMA & Prepaid Shipping Label",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Generates return merchandise authorization number and emails prepaid label.</p>
          </div>
          {onClose && (
