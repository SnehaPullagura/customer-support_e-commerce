...
interface CarrierTraceModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const CarrierTraceModal: React.FC<CarrierTraceModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Initiate Carrier Station Package Trace",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Files official lost package investigation request with destination sort hub.</p>
          </div>
          {onClose && (
