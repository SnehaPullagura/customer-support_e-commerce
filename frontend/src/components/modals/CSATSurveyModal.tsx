...
export const CSATSurveyModal: React.FC<CSATSurveyModalProps> = ({
  ...
  onClose,
  onSubmit,
  title = "Customer Satisfaction Feedback Collector",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Collects 1-5 star rating and open feedback after ticket resolution.</p>
          </div>
          {onClose && (
