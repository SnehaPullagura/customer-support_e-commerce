...
interface HazmatDisposalModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const HazmatDisposalModal: React.FC<HazmatDisposalModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Damaged Lithium Battery Safety Protocol",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Guides customer on local certified hazardous electronic recycling drop-off.</p>
          </div>
          {onClose && (
