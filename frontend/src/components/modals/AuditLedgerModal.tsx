...
export const AuditLedgerModal: React.FC<AuditLedgerModalProps> = ({
  ...
  onClose,
  onSubmit,
  title = "Immutable Financial Audit Trail Explorer",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Displays cryptographic proof of all price overrides, refunds, and cancellations.</p>
          </div>
          {onClose && (
