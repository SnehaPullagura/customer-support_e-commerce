...
interface B2BInvoiceAdjustModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const B2BInvoiceAdjustModal: React.FC<B2BInvoiceAdjustModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Wholesale PO Invoice Discrepancy Credit",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Adjusts line items on wholesale Net-30 invoice and issues credit memo.</p>
          </div>
          {onClose && (
