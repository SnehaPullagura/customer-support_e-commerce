...
interface RecallNoticeModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const RecallNoticeModal: React.FC<RecallNoticeModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "CPSC Product Safety Recall Notification",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Dispatches mandatory recall notice and hazmat return packing box.</p>
          </div>
          {onClose && (
