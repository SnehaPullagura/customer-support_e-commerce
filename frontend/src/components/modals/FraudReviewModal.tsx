...
export const FraudReviewModal: React.FC<FraudReviewModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Senior Fraud Officer Transaction Review",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Allows risk specialist to inspect IP proxy detection, card fingerprint, and velocity.</p>
          </div>
          {onClose && (
