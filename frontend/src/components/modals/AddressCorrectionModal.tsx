...
export const AddressCorrectionModal: React.FC<AddressCorrectionModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "In-Flight Carrier Address Correction",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Submits immediate package intercept and address update to FedEx/UPS.</p>
          </div>
          {onClose && (
