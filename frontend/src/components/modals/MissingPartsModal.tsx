...
interface MissingPartsModalProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const MissingPartsModal: React.FC<MissingPartsModalProps> = ({
  isOpen = true,
  onClose,
  onSubmit,
  title = "Accessory & Hardware Screw Kit Dispatch",
}) => {
      ...
      <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-slate-200 space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Dispatches missing cables, chargers, or assembly hardware at zero charge.</p>
          </div>
          {onClose && (
