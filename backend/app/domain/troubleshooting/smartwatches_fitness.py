"""
Smartwatches & Biometric Wearables Diagnostics
...
class SmartwatchesFitnessDiagnostics:
    CATEGORY_KEY = "smartwatches_fitness"
    CATEGORY_TITLE = "Smartwatches & Biometric Wearables Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your smartwatches & biometric wearables diagnostics exhibiting?",
