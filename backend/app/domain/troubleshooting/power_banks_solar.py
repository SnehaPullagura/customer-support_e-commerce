"""
Portable Power Stations & Solar Generators Diagnostics
...
class PowerBanksSolarDiagnostics:
    CATEGORY_KEY = "power_banks_solar"
    CATEGORY_TITLE = "Portable Power Stations & Solar Generators Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your portable power stations & solar generators diagnostics exhibiting?",
