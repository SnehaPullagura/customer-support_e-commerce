"""
Laptops & Notebook Computer Hardware Diagnostics
...
class LaptopsWorkstationsDiagnostics:
    CATEGORY_KEY = "laptops_workstations"
    CATEGORY_TITLE = "Laptops & Notebook Computer Hardware Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your laptops & notebook computer hardware diagnostics exhibiting?",
