"""
Mechanical Keyboards & Low-Latency Optical Mice Diagnostics
...
class KeyboardsMiceDiagnostics:
    CATEGORY_KEY = "keyboards_mice"
    CATEGORY_TITLE = "Mechanical Keyboards & Low-Latency Optical Mice Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your mechanical keyboards & low-latency optical mice diagnostics exhibiting?",
