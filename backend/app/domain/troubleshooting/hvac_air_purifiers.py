"""
HEPA Air Purifiers & Smart Dehumidifier Diagnostics
...
class HvacAirPurifiersDiagnostics:
    CATEGORY_KEY = "hvac_air_purifiers"
    CATEGORY_TITLE = "HEPA Air Purifiers & Smart Dehumidifier Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your hepa air purifiers & smart dehumidifier diagnostics exhibiting?",
