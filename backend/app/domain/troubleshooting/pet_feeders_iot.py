"""
Smart Automated Pet Feeders & Water Fountain Diagnostics
...
class PetFeedersIotDiagnostics:
    CATEGORY_KEY = "pet_feeders_iot"
    CATEGORY_TITLE = "Smart Automated Pet Feeders & Water Fountain Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your smart automated pet feeders & water fountain diagnostics exhibiting?",
