"""
Refrigerators, Dishwashers & Laundry Diagnostics
...
class LargeAppliancesDiagnostics:
    CATEGORY_KEY = "large_appliances"
    CATEGORY_TITLE = "Refrigerators, Dishwashers & Laundry Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your refrigerators, dishwashers & laundry diagnostics exhibiting?",
