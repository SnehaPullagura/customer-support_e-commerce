"""
Smart Home Hubs, Thermostats & Security Cameras Diagnostics
...
class SmartHomeIotDiagnostics:
    CATEGORY_KEY = "smart_home_iot"
    CATEGORY_TITLE = "Smart Home Hubs, Thermostats & Security Cameras Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your smart home hubs, thermostats & security cameras diagnostics exhibiting?",
