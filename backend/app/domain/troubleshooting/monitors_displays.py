"""
Gaming Monitors, HDMI 2.1 & DisplayPort Diagnostics
...
class MonitorsDisplaysDiagnostics:
    CATEGORY_KEY = "monitors_displays"
    CATEGORY_TITLE = "Gaming Monitors, HDMI 2.1 & DisplayPort Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your gaming monitors, hdmi 2.1 & displayport diagnostics exhibiting?",
