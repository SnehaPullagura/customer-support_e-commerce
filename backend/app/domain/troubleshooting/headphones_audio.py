"""
Headphones & True Wireless Audio Diagnostics
...
class HeadphonesAudioDiagnostics:
    CATEGORY_KEY = "headphones_audio"
    CATEGORY_TITLE = "Headphones & True Wireless Audio Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your headphones & true wireless audio diagnostics exhibiting?",
