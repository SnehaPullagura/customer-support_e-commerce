"""
Wireless Printers, Inks & Laser Cartridges Diagnostics
...
class PrintersScannersDiagnostics:
    CATEGORY_KEY = "printers_scanners"
    CATEGORY_TITLE = "Wireless Printers, Inks & Laser Cartridges Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your wireless printers, inks & laser cartridges diagnostics exhibiting?",
