"""
Aerial Drones & Telemetry Calibration Diagnostics
...
class DronesQuadcoptersDiagnostics:
    CATEGORY_KEY = "drones_quadcopters"
    CATEGORY_TITLE = "Aerial Drones & Telemetry Calibration Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your aerial drones & telemetry calibration diagnostics exhibiting?",
