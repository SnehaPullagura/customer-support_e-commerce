"""
Digital Cameras, Lenses & Gimbals Diagnostics
...
class CamerasOpticsDiagnostics:
    CATEGORY_KEY = "cameras_optics"
    CATEGORY_TITLE = "Digital Cameras, Lenses & Gimbals Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your digital cameras, lenses & gimbals diagnostics exhibiting?",
