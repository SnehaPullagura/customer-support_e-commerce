"""
RGB Smart Lighting, Hubs & Dimmer Switch Diagnostics
...
class SmartLightingDiagnostics:
    CATEGORY_KEY = "smart_lighting"
    CATEGORY_TITLE = "RGB Smart Lighting, Hubs & Dimmer Switch Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your rgb smart lighting, hubs & dimmer switch diagnostics exhibiting?",
