"""
Sublimated Dry Ice Disposal & Cold Box Quarantine
...
class PerishableDryIceHandlingGuide:
    GUIDE_KEY = "perishable_dry_ice_handling"
    GUIDE_TITLE = "Sublimated Dry Ice Disposal & Cold Box Quarantine"
