"""
Kibble Dispenser Anti-Jam Dual Rotor Reverse Cycle
...
class PetFeederMotorJamClearGuide:
    GUIDE_KEY = "pet_feeder_motor_jam_clear"
    GUIDE_TITLE = "Kibble Dispenser Anti-Jam Dual Rotor Reverse Cycle"
