"""
Cosmetic Pipette Airless Pump Cavitation Purge
...
class SkincareDropperClogPurgeGuide:
    GUIDE_KEY = "skincare_dropper_clog_purge"
    GUIDE_TITLE = "Cosmetic Pipette Airless Pump Cavitation Purge"
