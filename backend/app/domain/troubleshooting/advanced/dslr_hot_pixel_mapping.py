"""
DSLR Sensor Hot Pixel Mapping & Shutter Calibration
...
class DslrHotPixelMappingGuide:
    GUIDE_KEY = "dslr_hot_pixel_mapping"
    GUIDE_TITLE = "DSLR Sensor Hot Pixel Mapping & Shutter Calibration"
