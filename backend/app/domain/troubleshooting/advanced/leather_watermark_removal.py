"""
Full-Grain Leather Conditioning & Oil Stain Extraction
...
class LeatherWatermarkRemovalGuide:
    GUIDE_KEY = "leather_watermark_removal"
    GUIDE_TITLE = "Full-Grain Leather Conditioning & Oil Stain Extraction"
