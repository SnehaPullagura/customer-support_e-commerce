"""
HVAC 24V Common C-Wire Power Adapter Diagnostics
...
class ThermostatCWirePowerGuide:
    GUIDE_KEY = "thermostat_c_wire_power"
    GUIDE_TITLE = "HVAC 24V Common C-Wire Power Adapter Diagnostics"
