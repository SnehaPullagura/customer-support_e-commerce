"""
Dual Boiler Thermoblock Pressure & Descaling Routine
...
class EspressoBoilerDescalingGuide:
    GUIDE_KEY = "espresso_boiler_descaling"
    GUIDE_TITLE = "Dual Boiler Thermoblock Pressure & Descaling Routine"
