"""
Convection Heating Element Thermal Fuse Check
...
class AirFryerHeatingElementGuide:
    GUIDE_KEY = "air_fryer_heating_element"
    GUIDE_TITLE = "Convection Heating Element Thermal Fuse Check"
