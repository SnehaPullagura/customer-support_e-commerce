"""
Laser Distance Sensor (LDS) Bumper Jam Reset
...
class RobotVacuumLidarErrorGuide:
    GUIDE_KEY = "robot_vacuum_lidar_error"
    GUIDE_TITLE = "Laser Distance Sensor (LDS) Bumper Jam Reset"
