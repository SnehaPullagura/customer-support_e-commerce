"""
18k Gold Prong Tension & Stone Security Check
...
class FineJewelryProngTensionGuide:
    GUIDE_KEY = "fine_jewelry_prong_tension"
    GUIDE_TITLE = "18k Gold Prong Tension & Stone Security Check"
