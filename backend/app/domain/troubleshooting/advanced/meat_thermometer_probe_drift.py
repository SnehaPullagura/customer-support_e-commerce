"""
Boiling Water Ice Bath Dual Point Thermometer Calibration
...
class MeatThermometerProbeDriftGuide:
    GUIDE_KEY = "meat_thermometer_probe_drift"
    GUIDE_TITLE = "Boiling Water Ice Bath Dual Point Thermometer Calibration"
