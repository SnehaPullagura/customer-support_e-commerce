"""
Digital Manometer Pressure Calibration Audit
...
class CpapPressureDriftTestGuide:
    GUIDE_KEY = "cpap_pressure_drift_test"
    GUIDE_TITLE = "Digital Manometer Pressure Calibration Audit"
