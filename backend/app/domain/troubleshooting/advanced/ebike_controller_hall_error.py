"""
Brushless Hub Motor Hall Sensor Diagnostic Check
...
class EbikeControllerHallErrorGuide:
    GUIDE_KEY = "ebike_controller_hall_error"
    GUIDE_TITLE = "Brushless Hub Motor Hall Sensor Diagnostic Check"
