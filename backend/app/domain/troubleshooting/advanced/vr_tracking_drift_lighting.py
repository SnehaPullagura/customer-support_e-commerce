"""
Inside-Out Optical Tracking Drift & IR Interference
...
class VrTrackingDriftLightingGuide:
    GUIDE_KEY = "vr_tracking_drift_lighting"
    GUIDE_TITLE = "Inside-Out Optical Tracking Drift & IR Interference"
