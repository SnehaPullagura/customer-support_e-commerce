"""
Laser Radar False Positive Filtering & Shielding
...
class RadarDetectorLaserFalseGuide:
    GUIDE_KEY = "radar_detector_laser_false"
    GUIDE_TITLE = "Laser Radar False Positive Filtering & Shielding"
