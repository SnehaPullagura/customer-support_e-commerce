"""
LCD Screen Optical Polarization Reflection Test
...
class SunglassesPolarizationTestGuide:
    GUIDE_KEY = "sunglasses_polarization_test"
    GUIDE_TITLE = "LCD Screen Optical Polarization Reflection Test"
