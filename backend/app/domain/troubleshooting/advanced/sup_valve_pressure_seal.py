"""
Halkey-Roberts High-Pressure Inflatable Valve Tightening
...
class SupValvePressureSealGuide:
    GUIDE_KEY = "sup_valve_pressure_seal"
    GUIDE_TITLE = "Halkey-Roberts High-Pressure Inflatable Valve Tightening"
