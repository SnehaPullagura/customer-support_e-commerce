"""
Frost-Free Refrigerator Evaporator Drain Unclogging
...
class RefrigeratorDefrostDrainGuide:
    GUIDE_KEY = "refrigerator_defrost_drain"
    GUIDE_TITLE = "Frost-Free Refrigerator Evaporator Drain Unclogging"
