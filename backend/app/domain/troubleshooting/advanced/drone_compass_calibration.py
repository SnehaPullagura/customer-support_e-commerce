"""
Quadcopter Magnetometer & Compass Calibration Guide
...
class DroneCompassCalibrationGuide:
    GUIDE_KEY = "drone_compass_calibration"
    GUIDE_TITLE = "Quadcopter Magnetometer & Compass Calibration Guide"
