"""
Zigbee 3.0 Mesh Range & Channel Interference
...
class SmartBulbZigbeeMeshGuide:
    GUIDE_KEY = "smart_bulb_zigbee_mesh"
    GUIDE_TITLE = "Zigbee 3.0 Mesh Range & Channel Interference"
