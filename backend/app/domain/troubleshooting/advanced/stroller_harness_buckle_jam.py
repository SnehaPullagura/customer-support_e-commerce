"""
5-Point Safety Harness Sand Purge & Lubrication
...
class StrollerHarnessBuckleJamGuide:
    GUIDE_KEY = "stroller_harness_buckle_jam"
    GUIDE_TITLE = "5-Point Safety Harness Sand Purge & Lubrication"
