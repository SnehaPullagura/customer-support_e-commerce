"""
Class 4 Gas Lift Hydraulic Cylinder Replacement
...
class OfficeChairHydraulicSinkGuide:
    GUIDE_KEY = "office_chair_hydraulic_sink"
    GUIDE_TITLE = "Class 4 Gas Lift Hydraulic Cylinder Replacement"
