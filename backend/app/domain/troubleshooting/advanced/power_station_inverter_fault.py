"""
Pure Sine Wave Inverter Overload Fault Reset
...
class PowerStationInverterFaultGuide:
    GUIDE_KEY = "power_station_inverter_fault"
    GUIDE_TITLE = "Pure Sine Wave Inverter Overload Fault Reset"
