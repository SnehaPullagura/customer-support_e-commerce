"""
Inverter Generator Carburetor & Spark Plug Cleaning
...
class GeneratorSparkPlugFoulGuide:
    GUIDE_KEY = "generator_spark_plug_foul"
    GUIDE_TITLE = "Inverter Generator Carburetor & Spark Plug Cleaning"
