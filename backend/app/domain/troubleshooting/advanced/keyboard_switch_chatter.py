"""
Mechanical Key Switch Debounce & Hotswap Socket Repair
...
class KeyboardSwitchChatterGuide:
    GUIDE_KEY = "keyboard_switch_chatter"
    GUIDE_TITLE = "Mechanical Key Switch Debounce & Hotswap Socket Repair"
