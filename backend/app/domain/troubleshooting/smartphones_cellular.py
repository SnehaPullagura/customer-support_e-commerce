"""
Smartphones & Cellular Modems Diagnostics
...
class SmartphonesCellularDiagnostics:
    CATEGORY_KEY = "smartphones_cellular"
    CATEGORY_TITLE = "Smartphones & Cellular Modems Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your smartphones & cellular modems diagnostics exhibiting?",
