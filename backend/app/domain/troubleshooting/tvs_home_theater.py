"""
4K/8K Smart OLED TVs & Soundbar Diagnostics
...
class TvsHomeTheaterDiagnostics:
    CATEGORY_KEY = "tvs_home_theater"
    CATEGORY_TITLE = "4K/8K Smart OLED TVs & Soundbar Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your 4k/8k smart oled tvs & soundbar diagnostics exhibiting?",
