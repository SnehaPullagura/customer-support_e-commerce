"""
4K Dashcams & GPS Radar Detectors Diagnostics
...
class CarDashcamsDiagnostics:
    CATEGORY_KEY = "car_dashcams"
    CATEGORY_TITLE = "4K Dashcams & GPS Radar Detectors Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your 4k dashcams & gps radar detectors diagnostics exhibiting?",
