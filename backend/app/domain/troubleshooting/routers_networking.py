"""
Wi-Fi 7 Routers, Mesh Nodes & Switches Diagnostics
...
class RoutersNetworkingDiagnostics:
    CATEGORY_KEY = "routers_networking"
    CATEGORY_TITLE = "Wi-Fi 7 Routers, Mesh Nodes & Switches Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your wi-fi 7 routers, mesh nodes & switches diagnostics exhibiting?",
