"""
Electric Scooters & E-Bikes BMS Diagnostics
...
class ElectricScootersDiagnostics:
    CATEGORY_KEY = "electric_scooters"
    CATEGORY_TITLE = "Electric Scooters & E-Bikes BMS Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your electric scooters & e-bikes bms diagnostics exhibiting?",
