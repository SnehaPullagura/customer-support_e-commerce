"""
Cordless Power Tools & Li-Ion Battery Diagnostics
...
class PowerToolsDiagnostics:
    CATEGORY_KEY = "power_tools"
    CATEGORY_TITLE = "Cordless Power Tools & Li-Ion Battery Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your cordless power tools & li-ion battery diagnostics exhibiting?",
