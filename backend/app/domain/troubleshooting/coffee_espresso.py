"""
Espresso Machines & High-Pressure Pumps Diagnostics
...
class CoffeeEspressoDiagnostics:
    CATEGORY_KEY = "coffee_espresso"
    CATEGORY_TITLE = "Espresso Machines & High-Pressure Pumps Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your espresso machines & high-pressure pumps diagnostics exhibiting?",
