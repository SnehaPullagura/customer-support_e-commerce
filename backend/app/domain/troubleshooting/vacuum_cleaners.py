"""
Robot Vacuums & Cordless Cleaning Systems Diagnostics
...
class VacuumCleanersDiagnostics:
    CATEGORY_KEY = "vacuum_cleaners"
    CATEGORY_TITLE = "Robot Vacuums & Cordless Cleaning Systems Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your robot vacuums & cordless cleaning systems diagnostics exhibiting?",
