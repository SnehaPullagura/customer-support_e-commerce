"""
Digital Blood Pressure & Pulse Oximeter Diagnostics
...
class MedicalMonitorsDiagnostics:
    CATEGORY_KEY = "medical_monitors"
    CATEGORY_TITLE = "Digital Blood Pressure & Pulse Oximeter Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your digital blood pressure & pulse oximeter diagnostics exhibiting?",
