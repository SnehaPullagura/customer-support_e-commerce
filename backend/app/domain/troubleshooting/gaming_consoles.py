"""
Gaming Consoles, Controllers & VR Diagnostics
...
class GamingConsolesDiagnostics:
    CATEGORY_KEY = "gaming_consoles"
    CATEGORY_TITLE = "Gaming Consoles, Controllers & VR Diagnostics"
    ...
    def get_diagnostic_tree(cls) -> Dict[str, DiagnosticNode]:
        return {
            "START": DiagnosticNode(
                node_id="START",
                question_prompt="What specific symptom is your gaming consoles, controllers & vr diagnostics exhibiting?",
