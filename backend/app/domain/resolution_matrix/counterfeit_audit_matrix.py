"""
Brand Protection & Supply Chain Audit Matrix
...
class CounterfeitAuditMatrix:
    MATRIX_KEY = "counterfeit_audit_matrix"
    MATRIX_TITLE = "Brand Protection & Supply Chain Audit Matrix"
