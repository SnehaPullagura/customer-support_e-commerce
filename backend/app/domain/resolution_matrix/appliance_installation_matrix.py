"""
Third-Party Contractor Property Damage Matrix
...
class ApplianceInstallationMatrix:
    MATRIX_KEY = "appliance_installation_matrix"
    MATRIX_TITLE = "Third-Party Contractor Property Damage Matrix"
