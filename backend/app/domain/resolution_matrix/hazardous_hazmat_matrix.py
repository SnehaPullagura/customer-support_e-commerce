"""
DOT / IATA Hazardous Material Transport Matrix
...
class HazardousHazmatMatrix:
    MATRIX_KEY = "hazardous_hazmat_matrix"
    MATRIX_TITLE = "DOT / IATA Hazardous Material Transport Matrix"
