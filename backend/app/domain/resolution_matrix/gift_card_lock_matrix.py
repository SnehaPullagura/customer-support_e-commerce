"""
Voucher Balance Freezing & Anti-Theft Matrix
...
class GiftCardLockMatrix:
    MATRIX_KEY = "gift_card_lock_matrix"
    MATRIX_TITLE = "Voucher Balance Freezing & Anti-Theft Matrix"
