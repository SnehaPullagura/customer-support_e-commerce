"""
Digital Rights Management & Key Depletion Matrix
...
class SoftwareLicenseMatrix:
    MATRIX_KEY = "software_license_matrix"
    MATRIX_TITLE = "Digital Rights Management & Key Depletion Matrix"
