"""
Damaged Merchandise Payout & Goodwill Credit Matrix
...
class DamagedGoodsMatrix:
    MATRIX_KEY = "damaged_goods_matrix"
    MATRIX_TITLE = "Damaged Merchandise Payout & Goodwill Credit Matrix"
