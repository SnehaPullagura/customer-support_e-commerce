"""
Address Correction & Re-Routing Fee Matrix
...
class CourierAddressMatrix:
    MATRIX_KEY = "courier_address_matrix"
    MATRIX_TITLE = "Address Correction & Re-Routing Fee Matrix"
