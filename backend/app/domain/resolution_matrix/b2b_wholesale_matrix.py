"""
Net-30 Corporate Terms & Restocking Fee Matrix
...
class B2bWholesaleMatrix:
    MATRIX_KEY = "b2b_wholesale_matrix"
    MATRIX_TITLE = "Net-30 Corporate Terms & Restocking Fee Matrix"
