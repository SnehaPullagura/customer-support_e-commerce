"""
Multi-Warehouse Split Shipment Pacing Matrix
...
class SplitFulfillmentMatrix:
    MATRIX_KEY = "split_fulfillment_matrix"
    MATRIX_TITLE = "Multi-Warehouse Split Shipment Pacing Matrix"
