"""
Post-Purchase Competitor Price Adjustment Matrix
...
class PriceProtectionMatrix:
    MATRIX_KEY = "price_protection_matrix"
    MATRIX_TITLE = "Post-Purchase Competitor Price Adjustment Matrix"
