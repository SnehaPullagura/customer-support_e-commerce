"""
Used Device Cosmetic & Battery Health Matrix
...
class TradeInGradingMatrix:
    MATRIX_KEY = "trade_in_grading_matrix"
    MATRIX_TITLE = "Used Device Cosmetic & Battery Health Matrix"
