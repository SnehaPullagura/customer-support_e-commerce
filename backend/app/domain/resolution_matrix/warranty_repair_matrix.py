"""
Authorized Service Center Labor & Parts Matrix
...
class WarrantyRepairMatrix:
    MATRIX_KEY = "warranty_repair_matrix"
    MATRIX_TITLE = "Authorized Service Center Labor & Parts Matrix"
