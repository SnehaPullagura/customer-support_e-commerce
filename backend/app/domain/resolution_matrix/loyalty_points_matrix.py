"""
Rewards Points Recovery & Restoration Matrix
...
class LoyaltyPointsMatrix:
    MATRIX_KEY = "loyalty_points_matrix"
    MATRIX_TITLE = "Rewards Points Recovery & Restoration Matrix"
