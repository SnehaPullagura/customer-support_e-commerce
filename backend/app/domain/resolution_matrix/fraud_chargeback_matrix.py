"""
Dispute Liability & Evidence Burden Matrix
...
class FraudChargebackMatrix:
    MATRIX_KEY = "fraud_chargeback_matrix"
    MATRIX_TITLE = "Dispute Liability & Evidence Burden Matrix"
