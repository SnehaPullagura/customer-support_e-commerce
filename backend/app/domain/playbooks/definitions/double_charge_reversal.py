"""
Duplicate Payment Authorization & Void Protocol (DOUBLE_CHARGE_REVERSAL_V2)
...
class DoubleChargeReversalPlaybookContext(BaseModel):
    case_id: str
...
class DoubleChargeReversalPlaybookStepResult(BaseModel):
    step_order: int
    step_key: str
    status: str
    notes: str
...
class DoubleChargeReversalPlaybookHandler:
    """Enterprise resolution engine for Duplicate Payment Authorization & Void Protocol."""
    PLAYBOOK_CODE = "DOUBLE_CHARGE_REVERSAL_V2"
    PLAYBOOK_NAME = "Duplicate Payment Authorization & Void Protocol"
    CATEGORY = "BILLING"
    DESCRIPTION = "Stripe/PayPal authorization void and immediate refund."
    ...
    @classmethod
    async def run_step_1(cls, ctx: DoubleChargeReversalPlaybookContext) -> DoubleChargeReversalPlaybookStepResult:
        ctx.timeline_logs.append(f"Step 1 verified for case {ctx.case_id}")
        return DoubleChargeReversalPlaybookStepResult(
            step_order=1,
            step_key="STEP_1_AUDIT_PREREQUISITES",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_2(cls, ctx: DoubleChargeReversalPlaybookContext) -> DoubleChargeReversalPlaybookStepResult:
    ...
    @classmethod
    async def run_step_3(cls, ctx: DoubleChargeReversalPlaybookContext) -> DoubleChargeReversalPlaybookStepResult:
        return DoubleChargeReversalPlaybookStepResult(
            step_order=3,
            step_key="STEP_3_COMPUTE_RESOLUTION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_4(cls, ctx: DoubleChargeReversalPlaybookContext, custom_message: Optional[str] = None) -> DoubleChargeReversalPlaybookStepResult:
    ...
    @classmethod
    async def run_step_5(cls, ctx: DoubleChargeReversalPlaybookContext, mutation: str = "DEFAULT") -> DoubleChargeReversalPlaybookStepResult:
        return DoubleChargeReversalPlaybookStepResult(
            step_order=5,
            step_key="STEP_5_EXECUTE_COMMERCE_MUTATION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_6(cls, ctx: DoubleChargeReversalPlaybookContext) -> DoubleChargeReversalPlaybookStepResult:
        return DoubleChargeReversalPlaybookStepResult(
            step_order=6,
            step_key="STEP_6_PERSIST_AUDIT_LOGS",
            status="COMPLETED",
