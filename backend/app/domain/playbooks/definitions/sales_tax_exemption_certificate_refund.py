"""
Tax-Exempt Organization Certificate Audit & Refund (SALES_TAX_EXEMPTION_REFUND)
...
class SalesTaxExemptionCertificateRefundPlaybookContext(BaseModel):
    case_id: str
...
class SalesTaxExemptionCertificateRefundPlaybookStepResult(BaseModel):
    step_order: int
    step_key: str
    status: str
    notes: str
...
class SalesTaxExemptionCertificateRefundPlaybookHandler:
    """Enterprise resolution engine for Tax-Exempt Organization Certificate Audit & Refund."""
    PLAYBOOK_CODE = "SALES_TAX_EXEMPTION_REFUND"
    PLAYBOOK_NAME = "Tax-Exempt Organization Certificate Audit & Refund"
    CATEGORY = "BILLING"
    DESCRIPTION = "Reseller / 501(c)(3) tax ID validation, sales tax credit."
    ...
    @classmethod
    async def run_step_1(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext) -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
        ctx.timeline_logs.append(f"Step 1 verified for case {ctx.case_id}")
        return SalesTaxExemptionCertificateRefundPlaybookStepResult(
            step_order=1,
            step_key="STEP_1_AUDIT_PREREQUISITES",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_2(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext) -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
    ...
    @classmethod
    async def run_step_3(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext) -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
        return SalesTaxExemptionCertificateRefundPlaybookStepResult(
            step_order=3,
            step_key="STEP_3_COMPUTE_RESOLUTION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_4(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext, custom_message: Optional[str] = None) -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
    ...
    @classmethod
    async def run_step_5(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext, mutation: str = "DEFAULT") -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
        return SalesTaxExemptionCertificateRefundPlaybookStepResult(
            step_order=5,
            step_key="STEP_5_EXECUTE_COMMERCE_MUTATION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_6(cls, ctx: SalesTaxExemptionCertificateRefundPlaybookContext) -> SalesTaxExemptionCertificateRefundPlaybookStepResult:
        return SalesTaxExemptionCertificateRefundPlaybookStepResult(
            step_order=6,
            step_key="STEP_6_PERSIST_AUDIT_LOGS",
            status="COMPLETED",
