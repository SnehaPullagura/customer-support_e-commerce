"""
Klarna / Affirm / Afterpay Dispute Reconciliation (INSTALLMENT_BNPL_RECONCILIATION)
...
class InstallmentBnplReconciliationPlaybookContext(BaseModel):
    case_id: str
...
class InstallmentBnplReconciliationPlaybookStepResult(BaseModel):
    step_order: int
    step_key: str
    status: str
    notes: str
...
class InstallmentBnplReconciliationPlaybookHandler:
    """Enterprise resolution engine for Klarna / Affirm / Afterpay Dispute Reconciliation."""
    PLAYBOOK_CODE = "INSTALLMENT_BNPL_RECONCILIATION"
    PLAYBOOK_NAME = "Klarna / Affirm / Afterpay Dispute Reconciliation"
    CATEGORY = "BILLING"
    DESCRIPTION = "BNPL gateway refund sync, installment installment adjustment."
    ...
    @classmethod
    async def run_step_1(cls, ctx: InstallmentBnplReconciliationPlaybookContext) -> InstallmentBnplReconciliationPlaybookStepResult:
        ctx.timeline_logs.append(f"Step 1 verified for case {ctx.case_id}")
        return InstallmentBnplReconciliationPlaybookStepResult(
            step_order=1,
            step_key="STEP_1_AUDIT_PREREQUISITES",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_2(cls, ctx: InstallmentBnplReconciliationPlaybookContext) -> InstallmentBnplReconciliationPlaybookStepResult:
    ...
    @classmethod
    async def run_step_3(cls, ctx: InstallmentBnplReconciliationPlaybookContext) -> InstallmentBnplReconciliationPlaybookStepResult:
        return InstallmentBnplReconciliationPlaybookStepResult(
            step_order=3,
            step_key="STEP_3_COMPUTE_RESOLUTION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_4(cls, ctx: InstallmentBnplReconciliationPlaybookContext, custom_message: Optional[str] = None) -> InstallmentBnplReconciliationPlaybookStepResult:
    ...
    @classmethod
    async def run_step_5(cls, ctx: InstallmentBnplReconciliationPlaybookContext, mutation: str = "DEFAULT") -> InstallmentBnplReconciliationPlaybookStepResult:
        return InstallmentBnplReconciliationPlaybookStepResult(
            step_order=5,
            step_key="STEP_5_EXECUTE_COMMERCE_MUTATION",
            status="COMPLETED",
    ...
    @classmethod
    async def run_step_6(cls, ctx: InstallmentBnplReconciliationPlaybookContext) -> InstallmentBnplReconciliationPlaybookStepResult:
        return InstallmentBnplReconciliationPlaybookStepResult(
            step_order=6,
            step_key="STEP_6_PERSIST_AUDIT_LOGS",
            status="COMPLETED",
