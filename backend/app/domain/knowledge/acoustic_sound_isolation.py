"""
Acoustic Active Noise Cancellation & Headband Tuning Guide (KB_ANC_TUNE)
...
class AcousticSoundIsolationArticle(BaseModel):
    article_id: str = "KB_ANC_TUNE"
    title: str = "Acoustic Active Noise Cancellation & Headband Tuning Guide"
...
class AcousticSoundIsolation:
    """Knowledge article provider for Acoustic Active Noise Cancellation & Headband Tuning Guide."""
    ARTICLE_CODE = "KB_ANC_TUNE"
    ARTICLE_TITLE = "Acoustic Active Noise Cancellation & Headband Tuning Guide"

    @classmethod
    def get_article_content(cls) -> AcousticSoundIsolationArticle:
        return AcousticSoundIsolationArticle(
            diagnostic_symptoms=[
