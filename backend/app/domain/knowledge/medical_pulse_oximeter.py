"""
Plethysmogram Pulse Waveform Signal Quality Verification Guide (KB_PULSE_OXIMETER)
...
class MedicalPulseOximeterArticle(BaseModel):
    article_id: str = "KB_PULSE_OXIMETER"
    title: str = "Plethysmogram Pulse Waveform Signal Quality Verification Guide"
...
class MedicalPulseOximeter:
    """Knowledge article provider for Plethysmogram Pulse Waveform Signal Quality Verification Guide."""
    ARTICLE_CODE = "KB_PULSE_OXIMETER"
    ARTICLE_TITLE = "Plethysmogram Pulse Waveform Signal Quality Verification Guide"

    @classmethod
    def get_article_content(cls) -> MedicalPulseOximeterArticle:
        return MedicalPulseOximeterArticle(
            diagnostic_symptoms=[
