"""
Automotive Dashcam Supercapacitor Power Failure Protection Guide (KB_SUPERCAPACITOR)
...
class DashcamSupercapacitorArticle(BaseModel):
    article_id: str = "KB_SUPERCAPACITOR"
    title: str = "Automotive Dashcam Supercapacitor Power Failure Protection Guide"
...
class DashcamSupercapacitor:
    """Knowledge article provider for Automotive Dashcam Supercapacitor Power Failure Protection Guide."""
    ARTICLE_CODE = "KB_SUPERCAPACITOR"
    ARTICLE_TITLE = "Automotive Dashcam Supercapacitor Power Failure Protection Guide"

    @classmethod
    def get_article_content(cls) -> DashcamSupercapacitorArticle:
        return DashcamSupercapacitorArticle(
            diagnostic_symptoms=[
