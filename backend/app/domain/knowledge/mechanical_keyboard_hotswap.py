"""
Kailh Hotswap PCB Solder Joint Stress Cracking Repair Guide (KB_HOTSWAP_PCB)
...
class MechanicalKeyboardHotswapArticle(BaseModel):
    article_id: str = "KB_HOTSWAP_PCB"
    title: str = "Kailh Hotswap PCB Solder Joint Stress Cracking Repair Guide"
...
class MechanicalKeyboardHotswap:
    """Knowledge article provider for Kailh Hotswap PCB Solder Joint Stress Cracking Repair Guide."""
    ARTICLE_CODE = "KB_HOTSWAP_PCB"
    ARTICLE_TITLE = "Kailh Hotswap PCB Solder Joint Stress Cracking Repair Guide"

    @classmethod
    def get_article_content(cls) -> MechanicalKeyboardHotswapArticle:
        return MechanicalKeyboardHotswapArticle(
            diagnostic_symptoms=[
