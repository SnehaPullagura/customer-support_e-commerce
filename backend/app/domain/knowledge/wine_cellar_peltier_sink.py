"""
Thermoelectric Peltier Module Thermal Paste Degradation Guide (KB_PELTIER_SINK)
...
class WineCellarPeltierSinkArticle(BaseModel):
    article_id: str = "KB_PELTIER_SINK"
    title: str = "Thermoelectric Peltier Module Thermal Paste Degradation Guide"
...
class WineCellarPeltierSink:
    """Knowledge article provider for Thermoelectric Peltier Module Thermal Paste Degradation Guide."""
    ARTICLE_CODE = "KB_PELTIER_SINK"
    ARTICLE_TITLE = "Thermoelectric Peltier Module Thermal Paste Degradation Guide"

    @classmethod
    def get_article_content(cls) -> WineCellarPeltierSinkArticle:
        return WineCellarPeltierSinkArticle(
            diagnostic_symptoms=[
