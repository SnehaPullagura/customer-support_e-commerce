"""
High-Velocity Convection Fan Bearing Lubrication Guide (KB_AIR_FRYER_FAN)
...
class AirFryerConvectionFanArticle(BaseModel):
    article_id: str = "KB_AIR_FRYER_FAN"
    title: str = "High-Velocity Convection Fan Bearing Lubrication Guide"
...
class AirFryerConvectionFan:
    """Knowledge article provider for High-Velocity Convection Fan Bearing Lubrication Guide."""
    ARTICLE_CODE = "KB_AIR_FRYER_FAN"
    ARTICLE_TITLE = "High-Velocity Convection Fan Bearing Lubrication Guide"

    @classmethod
    def get_article_content(cls) -> AirFryerConvectionFanArticle:
        return AirFryerConvectionFanArticle(
            diagnostic_symptoms=[
