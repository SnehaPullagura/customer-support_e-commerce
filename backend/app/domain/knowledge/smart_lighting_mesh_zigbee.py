"""
Zigbee 3.0 Coordinator Radio Frequency Interference Guide (KB_ZIGBEE_RFI)
...
class SmartLightingMeshZigbeeArticle(BaseModel):
    article_id: str = "KB_ZIGBEE_RFI"
    title: str = "Zigbee 3.0 Coordinator Radio Frequency Interference Guide"
...
class SmartLightingMeshZigbee:
    """Knowledge article provider for Zigbee 3.0 Coordinator Radio Frequency Interference Guide."""
    ARTICLE_CODE = "KB_ZIGBEE_RFI"
    ARTICLE_TITLE = "Zigbee 3.0 Coordinator Radio Frequency Interference Guide"

    @classmethod
    def get_article_content(cls) -> SmartLightingMeshZigbeeArticle:
        return SmartLightingMeshZigbeeArticle(
            diagnostic_symptoms=[
