"""
Matter over Thread Border Router IPv6 Network Pairing Guide (KB_MATTER_THREAD)
...
class SmartHomeMatterThreadArticle(BaseModel):
    article_id: str = "KB_MATTER_THREAD"
    title: str = "Matter over Thread Border Router IPv6 Network Pairing Guide"
...
class SmartHomeMatterThread:
    """Knowledge article provider for Matter over Thread Border Router IPv6 Network Pairing Guide."""
    ARTICLE_CODE = "KB_MATTER_THREAD"
    ARTICLE_TITLE = "Matter over Thread Border Router IPv6 Network Pairing Guide"

    @classmethod
    def get_article_content(cls) -> SmartHomeMatterThreadArticle:
        return SmartHomeMatterThreadArticle(
            diagnostic_symptoms=[
