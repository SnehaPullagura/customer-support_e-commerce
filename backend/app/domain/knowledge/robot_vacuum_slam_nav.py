"""
Visual Simultaneous Localization and Mapping (vSLAM) Reset Guide (KB_VSLAM_NAV)
...
class RobotVacuumSlamNavArticle(BaseModel):
    article_id: str = "KB_VSLAM_NAV"
    title: str = "Visual Simultaneous Localization and Mapping (vSLAM) Reset Guide"
...
class RobotVacuumSlamNav:
    """Knowledge article provider for Visual Simultaneous Localization and Mapping (vSLAM) Reset Guide."""
    ARTICLE_CODE = "KB_VSLAM_NAV"
    ARTICLE_TITLE = "Visual Simultaneous Localization and Mapping (vSLAM) Reset Guide"

    @classmethod
    def get_article_content(cls) -> RobotVacuumSlamNavArticle:
        return RobotVacuumSlamNavArticle(
            diagnostic_symptoms=[
