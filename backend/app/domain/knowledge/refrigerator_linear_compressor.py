"""
Inverter Linear Compressor Inrush Current & R600a Diagnostics Guide (KB_COMPRESSOR_R600A)
...
class RefrigeratorLinearCompressorArticle(BaseModel):
    article_id: str = "KB_COMPRESSOR_R600A"
    title: str = "Inverter Linear Compressor Inrush Current & R600a Diagnostics Guide"
...
class RefrigeratorLinearCompressor:
    """Knowledge article provider for Inverter Linear Compressor Inrush Current & R600a Diagnostics Guide."""
    ARTICLE_CODE = "KB_COMPRESSOR_R600A"
    ARTICLE_TITLE = "Inverter Linear Compressor Inrush Current & R600a Diagnostics Guide"

    @classmethod
    def get_article_content(cls) -> RefrigeratorLinearCompressorArticle:
        return RefrigeratorLinearCompressorArticle(
            diagnostic_symptoms=[
