"""
Hall-Sensorless Field Oriented Control (FOC) Brushless Motor Guide (KB_BLDC_MOTOR)
...
class BrushlessPowerToolsArticle(BaseModel):
    article_id: str = "KB_BLDC_MOTOR"
    title: str = "Hall-Sensorless Field Oriented Control (FOC) Brushless Motor Guide"
...
class BrushlessPowerTools:
    """Knowledge article provider for Hall-Sensorless Field Oriented Control (FOC) Brushless Motor Guide."""
    ARTICLE_CODE = "KB_BLDC_MOTOR"
    ARTICLE_TITLE = "Hall-Sensorless Field Oriented Control (FOC) Brushless Motor Guide"

    @classmethod
    def get_article_content(cls) -> BrushlessPowerToolsArticle:
        return BrushlessPowerToolsArticle(
            diagnostic_symptoms=[
