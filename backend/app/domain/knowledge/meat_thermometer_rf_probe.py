"""
Wireless Sub-1GHz RF Core Probe Synchronization Guide (KB_RF_MEAT_PROBE)
...
class MeatThermometerRfProbeArticle(BaseModel):
    article_id: str = "KB_RF_MEAT_PROBE"
    title: str = "Wireless Sub-1GHz RF Core Probe Synchronization Guide"
...
class MeatThermometerRfProbe:
    """Knowledge article provider for Wireless Sub-1GHz RF Core Probe Synchronization Guide."""
    ARTICLE_CODE = "KB_RF_MEAT_PROBE"
    ARTICLE_TITLE = "Wireless Sub-1GHz RF Core Probe Synchronization Guide"

    @classmethod
    def get_article_content(cls) -> MeatThermometerRfProbeArticle:
        return MeatThermometerRfProbeArticle(
            diagnostic_symptoms=[
