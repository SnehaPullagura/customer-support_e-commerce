"""
G-Sync Compatible Variable Refresh Rate (VRR) Flicker Tuning Guide (KB_VRR_FLICKER)
...
class GamingMonitorVrrFlickerArticle(BaseModel):
    article_id: str = "KB_VRR_FLICKER"
    title: str = "G-Sync Compatible Variable Refresh Rate (VRR) Flicker Tuning Guide"
...
class GamingMonitorVrrFlicker:
    """Knowledge article provider for G-Sync Compatible Variable Refresh Rate (VRR) Flicker Tuning Guide."""
    ARTICLE_CODE = "KB_VRR_FLICKER"
    ARTICLE_TITLE = "G-Sync Compatible Variable Refresh Rate (VRR) Flicker Tuning Guide"

    @classmethod
    def get_article_content(cls) -> GamingMonitorVrrFlickerArticle:
        return GamingMonitorVrrFlickerArticle(
            diagnostic_symptoms=[
