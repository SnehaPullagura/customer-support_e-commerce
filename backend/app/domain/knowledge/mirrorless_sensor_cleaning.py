"""
Full-Frame CMOS Sensor Dry Cleaning & Dust Purge Guide (KB_SENSOR_CLEAN)
...
class MirrorlessSensorCleaningArticle(BaseModel):
    article_id: str = "KB_SENSOR_CLEAN"
    title: str = "Full-Frame CMOS Sensor Dry Cleaning & Dust Purge Guide"
...
class MirrorlessSensorCleaning:
    """Knowledge article provider for Full-Frame CMOS Sensor Dry Cleaning & Dust Purge Guide."""
    ARTICLE_CODE = "KB_SENSOR_CLEAN"
    ARTICLE_TITLE = "Full-Frame CMOS Sensor Dry Cleaning & Dust Purge Guide"

    @classmethod
    def get_article_content(cls) -> MirrorlessSensorCleaningArticle:
        return MirrorlessSensorCleaningArticle(
            diagnostic_symptoms=[
