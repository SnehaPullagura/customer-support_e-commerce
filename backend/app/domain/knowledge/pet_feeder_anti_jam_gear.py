"""
Planetary Reduction Gearbox Anti-Jam Reverse Logic Guide (KB_FEEDER_GEARBOX)
...
class PetFeederAntiJamGearArticle(BaseModel):
    article_id: str = "KB_FEEDER_GEARBOX"
    title: str = "Planetary Reduction Gearbox Anti-Jam Reverse Logic Guide"
...
class PetFeederAntiJamGear:
    """Knowledge article provider for Planetary Reduction Gearbox Anti-Jam Reverse Logic Guide."""
    ARTICLE_CODE = "KB_FEEDER_GEARBOX"
    ARTICLE_TITLE = "Planetary Reduction Gearbox Anti-Jam Reverse Logic Guide"

    @classmethod
    def get_article_content(cls) -> PetFeederAntiJamGearArticle:
        return PetFeederAntiJamGearArticle(
            diagnostic_symptoms=[
