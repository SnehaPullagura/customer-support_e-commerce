"""
PCIe Gen4 NVMe Thermal Throttling & Heatsink Installation Guide (KB_NVME_THROTTLE)
...
class LaptopNvmeThermalArticle(BaseModel):
    article_id: str = "KB_NVME_THROTTLE"
    title: str = "PCIe Gen4 NVMe Thermal Throttling & Heatsink Installation Guide"
...
class LaptopNvmeThermal:
    """Knowledge article provider for PCIe Gen4 NVMe Thermal Throttling & Heatsink Installation Guide."""
    ARTICLE_CODE = "KB_NVME_THROTTLE"
    ARTICLE_TITLE = "PCIe Gen4 NVMe Thermal Throttling & Heatsink Installation Guide"

    @classmethod
    def get_article_content(cls) -> LaptopNvmeThermalArticle:
        return LaptopNvmeThermalArticle(
            diagnostic_symptoms=[
