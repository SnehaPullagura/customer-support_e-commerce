"""
OLED Panel Sub-Pixel Compensation Cycle & Burn-In Prevention Guide (KB_OLED_REFRESH)
...
class OledPixelRefresherArticle(BaseModel):
    article_id: str = "KB_OLED_REFRESH"
    title: str = "OLED Panel Sub-Pixel Compensation Cycle & Burn-In Prevention Guide"
...
class OledPixelRefresher:
    """Knowledge article provider for OLED Panel Sub-Pixel Compensation Cycle & Burn-In Prevention Guide."""
    ARTICLE_CODE = "KB_OLED_REFRESH"
    ARTICLE_TITLE = "OLED Panel Sub-Pixel Compensation Cycle & Burn-In Prevention Guide"

    @classmethod
    def get_article_content(cls) -> OledPixelRefresherArticle:
        return OledPixelRefresherArticle(
            diagnostic_symptoms=[
