"""
Pure Sine Inverter Generator Carburetor Ultrasonic Cleaning Guide (KB_INVERTER_CARB)
...
class InverterGeneratorCarbArticle(BaseModel):
    article_id: str = "KB_INVERTER_CARB"
    title: str = "Pure Sine Inverter Generator Carburetor Ultrasonic Cleaning Guide"
...
class InverterGeneratorCarb:
    """Knowledge article provider for Pure Sine Inverter Generator Carburetor Ultrasonic Cleaning Guide."""
    ARTICLE_CODE = "KB_INVERTER_CARB"
    ARTICLE_TITLE = "Pure Sine Inverter Generator Carburetor Ultrasonic Cleaning Guide"

    @classmethod
    def get_article_content(cls) -> InverterGeneratorCarbArticle:
        return InverterGeneratorCarbArticle(
            diagnostic_symptoms=[
