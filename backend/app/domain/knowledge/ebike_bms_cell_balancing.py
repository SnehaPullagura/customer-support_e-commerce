"""
Lithium-Ion 13S Battery Management System (BMS) Balancing Guide (KB_BMS_BALANCING)
...
class EbikeBmsCellBalancingArticle(BaseModel):
    article_id: str = "KB_BMS_BALANCING"
    title: str = "Lithium-Ion 13S Battery Management System (BMS) Balancing Guide"
...
class EbikeBmsCellBalancing:
    """Knowledge article provider for Lithium-Ion 13S Battery Management System (BMS) Balancing Guide."""
    ARTICLE_CODE = "KB_BMS_BALANCING"
    ARTICLE_TITLE = "Lithium-Ion 13S Battery Management System (BMS) Balancing Guide"

    @classmethod
    def get_article_content(cls) -> EbikeBmsCellBalancingArticle:
        return EbikeBmsCellBalancingArticle(
            diagnostic_symptoms=[
