"""
Optical Photoplethysmography & ECG Sensor Calibration Guide (KB_ECG_SENSOR)
...
class SmartwatchEcgSensorArticle(BaseModel):
    article_id: str = "KB_ECG_SENSOR"
    title: str = "Optical Photoplethysmography & ECG Sensor Calibration Guide"
...
class SmartwatchEcgSensor:
    """Knowledge article provider for Optical Photoplethysmography & ECG Sensor Calibration Guide."""
    ARTICLE_CODE = "KB_ECG_SENSOR"
    ARTICLE_TITLE = "Optical Photoplethysmography & ECG Sensor Calibration Guide"

    @classmethod
    def get_article_content(cls) -> SmartwatchEcgSensorArticle:
        return SmartwatchEcgSensorArticle(
            diagnostic_symptoms=[
