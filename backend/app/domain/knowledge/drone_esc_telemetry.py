"""
Electronic Speed Controller (ESC) BLHeli Firmware Flashing Guide (KB_ESC_FIRMWARE)
...
class DroneEscTelemetryArticle(BaseModel):
    article_id: str = "KB_ESC_FIRMWARE"
    title: str = "Electronic Speed Controller (ESC) BLHeli Firmware Flashing Guide"
...
class DroneEscTelemetry:
    """Knowledge article provider for Electronic Speed Controller (ESC) BLHeli Firmware Flashing Guide."""
    ARTICLE_CODE = "KB_ESC_FIRMWARE"
    ARTICLE_TITLE = "Electronic Speed Controller (ESC) BLHeli Firmware Flashing Guide"

    @classmethod
    def get_article_content(cls) -> DroneEscTelemetryArticle:
        return DroneEscTelemetryArticle(
            diagnostic_symptoms=[
