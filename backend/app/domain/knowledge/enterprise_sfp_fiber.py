"""
10GbE SFP+ Optical Transceiver DOM Diagnostic & Cleaning Guide (KB_SFP_OPTICAL)
...
class EnterpriseSfpFiberArticle(BaseModel):
    article_id: str = "KB_SFP_OPTICAL"
    title: str = "10GbE SFP+ Optical Transceiver DOM Diagnostic & Cleaning Guide"
...
class EnterpriseSfpFiber:
    """Knowledge article provider for 10GbE SFP+ Optical Transceiver DOM Diagnostic & Cleaning Guide."""
    ARTICLE_CODE = "KB_SFP_OPTICAL"
    ARTICLE_TITLE = "10GbE SFP+ Optical Transceiver DOM Diagnostic & Cleaning Guide"

    @classmethod
    def get_article_content(cls) -> EnterpriseSfpFiberArticle:
        return EnterpriseSfpFiberArticle(
            diagnostic_symptoms=[
