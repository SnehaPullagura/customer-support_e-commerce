"""
ANSI Grade 1 Motorized Deadbolt Misalignment & Strike Plate Guide (KB_DEADBOLT_STRIKE)
...
class SmartLockDeadboltFrictionArticle(BaseModel):
    article_id: str = "KB_DEADBOLT_STRIKE"
    title: str = "ANSI Grade 1 Motorized Deadbolt Misalignment & Strike Plate Guide"
...
class SmartLockDeadboltFriction:
    """Knowledge article provider for ANSI Grade 1 Motorized Deadbolt Misalignment & Strike Plate Guide."""
    ARTICLE_CODE = "KB_DEADBOLT_STRIKE"
    ARTICLE_TITLE = "ANSI Grade 1 Motorized Deadbolt Misalignment & Strike Plate Guide"

    @classmethod
    def get_article_content(cls) -> SmartLockDeadboltFrictionArticle:
        return SmartLockDeadboltFrictionArticle(
            diagnostic_symptoms=[
