"""
Laser Printer Fuser Assembly Thermal Thermistor Replacement Guide (KB_FUSER_THERMISTOR)
...
class LaserPrinterFuserRollerArticle(BaseModel):
    article_id: str = "KB_FUSER_THERMISTOR"
    title: str = "Laser Printer Fuser Assembly Thermal Thermistor Replacement Guide"
...
class LaserPrinterFuserRoller:
    """Knowledge article provider for Laser Printer Fuser Assembly Thermal Thermistor Replacement Guide."""
    ARTICLE_CODE = "KB_FUSER_THERMISTOR"
    ARTICLE_TITLE = "Laser Printer Fuser Assembly Thermal Thermistor Replacement Guide"

    @classmethod
    def get_article_content(cls) -> LaserPrinterFuserRollerArticle:
        return LaserPrinterFuserRollerArticle(
            diagnostic_symptoms=[
