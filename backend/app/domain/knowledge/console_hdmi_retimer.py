"""
HDMI 2.1 Retimer IC Diagnostic & 120Hz 4K Signal Guide (KB_HDMI_RETIMER)
...
class ConsoleHdmiRetimerArticle(BaseModel):
    article_id: str = "KB_HDMI_RETIMER"
    title: str = "HDMI 2.1 Retimer IC Diagnostic & 120Hz 4K Signal Guide"
...
class ConsoleHdmiRetimer:
    """Knowledge article provider for HDMI 2.1 Retimer IC Diagnostic & 120Hz 4K Signal Guide."""
    ARTICLE_CODE = "KB_HDMI_RETIMER"
    ARTICLE_TITLE = "HDMI 2.1 Retimer IC Diagnostic & 120Hz 4K Signal Guide"

    @classmethod
    def get_article_content(cls) -> ConsoleHdmiRetimerArticle:
        return ConsoleHdmiRetimerArticle(
            diagnostic_symptoms=[
