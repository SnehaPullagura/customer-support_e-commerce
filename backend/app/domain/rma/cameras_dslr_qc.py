"""
Mirrorless Shutter Count & Sensor Dust QC Standard (RMA_CAM)
...
class CamerasDslrQc:
    QC_CODE = "RMA_CAM"
    QC_TITLE = "Mirrorless Shutter Count & Sensor Dust QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_CAM-01",
