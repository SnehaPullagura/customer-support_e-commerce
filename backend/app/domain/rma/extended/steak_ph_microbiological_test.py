"""
Fresh Meat Core Temperature & pH Spoilage Audit (RMA_PH)
...
class SteakPhMicrobiologicalTest:
    PROTOCOL_CODE = "RMA_PH"
    PROTOCOL_TITLE = "Fresh Meat Core Temperature & pH Spoilage Audit"
