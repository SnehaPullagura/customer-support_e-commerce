"""
Bottom Bracket Strain Gauge Torque Sensor Cal (RMA_TORQUE)
...
class EbikeTorqueTransducerTest:
    PROTOCOL_CODE = "RMA_TORQUE"
    PROTOCOL_TITLE = "Bottom Bracket Strain Gauge Torque Sensor Cal"
