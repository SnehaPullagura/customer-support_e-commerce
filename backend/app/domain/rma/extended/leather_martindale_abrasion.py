"""
Martindale Abrasion & Color Rub Fastness QC (RMA_ABRASION)
...
class LeatherMartindaleAbrasion:
    PROTOCOL_CODE = "RMA_ABRASION"
    PROTOCOL_TITLE = "Martindale Abrasion & Color Rub Fastness QC"
