"""
Cosmetic Formulation Centipoise Viscosity Audit (RMA_VISCOSITY)
...
class SerumViscosityRheometer:
    PROTOCOL_CODE = "RMA_VISCOSITY"
    PROTOCOL_TITLE = "Cosmetic Formulation Centipoise Viscosity Audit"
