"""
Total Harmonic Distortion Acoustic Chamber Test (RMA_THD)
...
class SoundbarThdDistortion:
    PROTOCOL_CODE = "RMA_THD"
    PROTOCOL_TITLE = "Total Harmonic Distortion Acoustic Chamber Test"
