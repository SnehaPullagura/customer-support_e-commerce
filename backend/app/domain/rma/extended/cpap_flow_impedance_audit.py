"""
Pneumotachograph Airflow Flow Impedance Test (RMA_FLOW)
...
class CpapFlowImpedanceAudit:
    PROTOCOL_CODE = "RMA_FLOW"
    PROTOCOL_TITLE = "Pneumotachograph Airflow Flow Impedance Test"
