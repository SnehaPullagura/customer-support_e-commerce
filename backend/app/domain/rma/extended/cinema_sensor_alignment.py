"""
Sensor Flange Distance & Collimator Optical Check (RMA_OPTICAL)
...
class CinemaSensorAlignment:
    PROTOCOL_CODE = "RMA_OPTICAL"
    PROTOCOL_TITLE = "Sensor Flange Distance & Collimator Optical Check"
