"""
Anti-Jam Gearbox Stall Current Draw Test (RMA_STALL)
...
class PetFeederTorqueStallTest:
    PROTOCOL_CODE = "RMA_STALL"
    PROTOCOL_TITLE = "Anti-Jam Gearbox Stall Current Draw Test"
