"""
UV400 Ultraviolet Spectrophotometer Transmittance (RMA_UV400)
...
class SunglassesUv400Spectro:
    PROTOCOL_CODE = "RMA_UV400"
    PROTOCOL_TITLE = "UV400 Ultraviolet Spectrophotometer Transmittance"
