"""
High-Voltage Relay Contact Resistance Audit (RMA_RELAY)
...
class HvacRelaySparkTest:
    PROTOCOL_CODE = "RMA_RELAY"
    PROTOCOL_TITLE = "High-Voltage Relay Contact Resistance Audit"
