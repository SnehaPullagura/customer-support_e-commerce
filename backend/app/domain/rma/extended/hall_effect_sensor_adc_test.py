"""
Hall Effect Magnetic Switch ADC Linearity Check (RMA_HALL)
...
class HallEffectSensorAdcTest:
    PROTOCOL_CODE = "RMA_HALL"
    PROTOCOL_TITLE = "Hall Effect Magnetic Switch ADC Linearity Check"
