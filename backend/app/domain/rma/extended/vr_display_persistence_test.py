"""
Micro-OLED Display Pixel Switching Latency Test (RMA_LATENCY)
...
class VrDisplayPersistenceTest:
    PROTOCOL_CODE = "RMA_LATENCY"
    PROTOCOL_TITLE = "Micro-OLED Display Pixel Switching Latency Test"
