"""
Pure Sine Wave Inverter Total Harmonic Test (RMA_SINE)
...
class SolarInverterHarmonicTest:
    PROTOCOL_CODE = "RMA_SINE"
    PROTOCOL_TITLE = "Pure Sine Wave Inverter Total Harmonic Test"
