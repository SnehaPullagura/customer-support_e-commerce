"""
Quadcopter Motor Thrust & Dynamic Balance Inspection (RMA_THRUST)
...
class DroneMotorThrustTest:
    PROTOCOL_CODE = "RMA_THRUST"
    PROTOCOL_TITLE = "Quadcopter Motor Thrust & Dynamic Balance Inspection"
