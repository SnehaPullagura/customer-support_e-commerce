"""
FTIR Spectroscopy Diamond Lab Growth Verification (RMA_FTIR)
...
class DiamondSpectrometerGemTest:
    PROTOCOL_CODE = "RMA_FTIR"
    PROTOCOL_TITLE = "FTIR Spectroscopy Diamond Lab Growth Verification"
