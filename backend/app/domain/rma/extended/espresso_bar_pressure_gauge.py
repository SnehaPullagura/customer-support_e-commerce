"""
9-Bar Extraction Portafilter Pressure Gauge Test (RMA_PRESSURE)
...
class EspressoBarPressureGauge:
    PROTOCOL_CODE = "RMA_PRESSURE"
    PROTOCOL_TITLE = "9-Bar Extraction Portafilter Pressure Gauge Test"
