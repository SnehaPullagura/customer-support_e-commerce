"""
Class 4 Gas Lift Hydraulic Fatigue Testing (RMA_HYDRAULIC)
...
class GasLiftBurstPressureTest:
    PROTOCOL_CODE = "RMA_HYDRAULIC"
    PROTOCOL_TITLE = "Class 4 Gas Lift Hydraulic Fatigue Testing"
