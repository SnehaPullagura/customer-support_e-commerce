"""
High-Speed Blade Dynamic Balance & Vibration Check (RMA_BLADE)
...
class LawnMowerBladeBalance:
    PROTOCOL_CODE = "RMA_BLADE"
    PROTOCOL_TITLE = "High-Speed Blade Dynamic Balance & Vibration Check"
