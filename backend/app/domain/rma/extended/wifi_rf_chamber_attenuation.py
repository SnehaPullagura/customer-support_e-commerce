"""
RF Anechoic Chamber Transmit Power Calibration (RMA_RF)
...
class WifiRfChamberAttenuation:
    PROTOCOL_CODE = "RMA_RF"
    PROTOCOL_TITLE = "RF Anechoic Chamber Transmit Power Calibration"
