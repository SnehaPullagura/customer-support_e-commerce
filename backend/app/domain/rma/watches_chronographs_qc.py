"""
Automatic Chronograph Timekeeping Drift QC Standard (RMA_WATCH)
...
class WatchesChronographsQc:
    QC_CODE = "RMA_WATCH"
    QC_TITLE = "Automatic Chronograph Timekeeping Drift QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_WATCH-01",
