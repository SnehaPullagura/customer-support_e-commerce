"""
HEPA Filter Sensors & Air Quality QC Standard (RMA_HVAC)
...
class HvacPurifiersQc:
    QC_CODE = "RMA_HVAC"
    QC_TITLE = "HEPA Filter Sensors & Air Quality QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_HVAC-01",
