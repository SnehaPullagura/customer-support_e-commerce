"""
Consoles & HDMI Port Micro-Fracture QC Standard (RMA_GAME)
...
class GamingConsolesQc:
    QC_CODE = "RMA_GAME"
    QC_TITLE = "Consoles & HDMI Port Micro-Fracture QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_GAME-01",
