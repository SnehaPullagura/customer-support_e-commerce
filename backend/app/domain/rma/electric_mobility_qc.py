"""
E-Bikes & Battery Management Systems QC Standard (RMA_BMS)
...
class ElectricMobilityQc:
    QC_CODE = "RMA_BMS"
    QC_TITLE = "E-Bikes & Battery Management Systems QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_BMS-01",
