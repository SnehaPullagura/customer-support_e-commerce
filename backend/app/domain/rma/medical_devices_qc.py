"""
Medical Devices & Sanitation QC Standard (RMA_HEALTH)
...
class MedicalDevicesQc:
    QC_CODE = "RMA_HEALTH"
    QC_TITLE = "Medical Devices & Sanitation QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_HEALTH-01",
