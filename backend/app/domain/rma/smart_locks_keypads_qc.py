"""
Biometric Sensors & Motor Deadbolt QC Standard (RMA_LOCK)
...
class SmartLocksKeypadsQc:
    QC_CODE = "RMA_LOCK"
    QC_TITLE = "Biometric Sensors & Motor Deadbolt QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_LOCK-01",
