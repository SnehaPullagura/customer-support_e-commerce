"""
Power Tools & Motor Torque QC Standard (RMA_TOOLS)
...
class PowerToolsQc:
    QC_CODE = "RMA_TOOLS"
    QC_TITLE = "Power Tools & Motor Torque QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_TOOLS-01",
