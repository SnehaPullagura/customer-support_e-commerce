"""
Designer Leather & Stitching QC Standard (RMA_LEATHER)
...
class LuxuryHandbagsQc:
    QC_CODE = "RMA_LEATHER"
    QC_TITLE = "Designer Leather & Stitching QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_LEATHER-01",
