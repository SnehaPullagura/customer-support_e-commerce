"""
Headphones & Acoustic Drivers QC Standard (RMA_AUDIO)
...
class AudioQc:
    QC_CODE = "RMA_AUDIO"
    QC_TITLE = "Headphones & Acoustic Drivers QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_AUDIO-01",
