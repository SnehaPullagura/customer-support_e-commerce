"""
Footwear & Outsole Wear QC Standard (RMA_SHOES)
...
class FootwearSneakersQc:
    QC_CODE = "RMA_SHOES"
    QC_TITLE = "Footwear & Outsole Wear QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_SHOES-01",
