"""
Polarized Eyewear & Frame Alignment QC Standard (RMA_OPTIC)
...
class EyewearOpticsQc:
    QC_CODE = "RMA_OPTIC"
    QC_TITLE = "Polarized Eyewear & Frame Alignment QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_OPTIC-01",
