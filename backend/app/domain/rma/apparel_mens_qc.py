"""
Men's Apparel Fabric & Hemline QC Standard (RMA_MENS)
...
class ApparelMensQc:
    QC_CODE = "RMA_MENS"
    QC_TITLE = "Men's Apparel Fabric & Hemline QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_MENS-01",
