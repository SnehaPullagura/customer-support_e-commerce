"""
Fine Jewelry & Precious Metal QC Standard (RMA_JEWELRY)
...
class LuxuryJewelryQc:
    QC_CODE = "RMA_JEWELRY"
    QC_TITLE = "Fine Jewelry & Precious Metal QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_JEWELRY-01",
