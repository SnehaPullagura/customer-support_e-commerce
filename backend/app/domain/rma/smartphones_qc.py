"""
Smartphones & Mobile Devices QC Standard (RMA_MOBILE)
...
class SmartphonesQc:
    QC_CODE = "RMA_MOBILE"
    QC_TITLE = "Smartphones & Mobile Devices QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_MOBILE-01",
