"""
Women's Apparel Silk & Lace QC Standard (RMA_WOMENS)
...
class ApparelWomensQc:
    QC_CODE = "RMA_WOMENS"
    QC_TITLE = "Women's Apparel Silk & Lace QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_WOMENS-01",
