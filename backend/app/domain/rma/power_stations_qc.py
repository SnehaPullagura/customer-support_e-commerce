"""
Portable Solar Inverters & Pure Sine Wave QC Standard (RMA_SOLAR)
...
class PowerStationsQc:
    QC_CODE = "RMA_SOLAR"
    QC_TITLE = "Portable Solar Inverters & Pure Sine Wave QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_SOLAR-01",
