"""
OLED Panels & Dead Pixel Cluster QC Standard (RMA_DISPLAY)
...
class TelevisionsMonitorsQc:
    QC_CODE = "RMA_DISPLAY"
    QC_TITLE = "OLED Panels & Dead Pixel Cluster QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_DISPLAY-01",
