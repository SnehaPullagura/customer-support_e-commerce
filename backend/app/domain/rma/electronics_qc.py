"""
Electronics & PCB Return Quality Control (RMA_ELEC)
...
class ElectronicsQc:
    QC_CODE = "RMA_ELEC"
    QC_TITLE = "Electronics & PCB Return Quality Control"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_ELEC-01",
