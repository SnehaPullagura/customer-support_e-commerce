"""
Smart IoT Hubs & Zigbee Pairing QC Standard (RMA_IOT)
...
class SmartHomeIotQc:
    QC_CODE = "RMA_IOT"
    QC_TITLE = "Smart IoT Hubs & Zigbee Pairing QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_IOT-01",
