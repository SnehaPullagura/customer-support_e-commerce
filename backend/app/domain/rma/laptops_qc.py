"""
Laptops & Computing Motherboards QC Standard (RMA_COMP)
...
class LaptopsQc:
    QC_CODE = "RMA_COMP"
    QC_TITLE = "Laptops & Computing Motherboards QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_COMP-01",
