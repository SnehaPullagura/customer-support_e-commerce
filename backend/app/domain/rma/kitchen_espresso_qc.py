"""
Espresso Boiler Pressure & Solenoid QC Standard (RMA_COFFEE)
...
class KitchenEspressoQc:
    QC_CODE = "RMA_COFFEE"
    QC_TITLE = "Espresso Boiler Pressure & Solenoid QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_COFFEE-01",
