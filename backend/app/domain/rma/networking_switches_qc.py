"""
Enterprise Routers & SFP Port QC Standard (RMA_NET)
...
class NetworkingSwitchesQc:
    QC_CODE = "RMA_NET"
    QC_TITLE = "Enterprise Routers & SFP Port QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_NET-01",
