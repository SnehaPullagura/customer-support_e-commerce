"""
Home Appliances & Compressors QC Standard (RMA_APP)
...
class AppliancesQc:
    QC_CODE = "RMA_APP"
    QC_TITLE = "Home Appliances & Compressors QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_APP-01",
