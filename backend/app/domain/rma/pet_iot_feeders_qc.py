"""
Automated Feeders & Motor Stall QC Standard (RMA_PET)
...
class PetIotFeedersQc:
    QC_CODE = "RMA_PET"
    QC_TITLE = "Automated Feeders & Motor Stall QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_PET-01",
