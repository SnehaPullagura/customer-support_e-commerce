"""
Quadcopter Gimbals & Flight Log QC Standard (RMA_DRONE)
...
class DronesOpticsQc:
    QC_CODE = "RMA_DRONE"
    QC_TITLE = "Quadcopter Gimbals & Flight Log QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_DRONE-01",
