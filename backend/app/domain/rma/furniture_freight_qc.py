"""
Freight Furniture Hardwood Joints QC Standard (RMA_FURN)
...
class FurnitureFreightQc:
    QC_CODE = "RMA_FURN"
    QC_TITLE = "Freight Furniture Hardwood Joints QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_FURN-01",
