"""
Cosmetics & Tamper-Evident Seals QC Standard (RMA_BEAUTY)
...
class CosmeticsSkincareQc:
    QC_CODE = "RMA_BEAUTY"
    QC_TITLE = "Cosmetics & Tamper-Evident Seals QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_BEAUTY-01",
