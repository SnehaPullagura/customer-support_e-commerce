"""
Dashcam Supercapacitors & Night Vision QC Standard (RMA_AUTO)
...
class CarElectronicsQc:
    QC_CODE = "RMA_AUTO"
    QC_TITLE = "Dashcam Supercapacitors & Night Vision QC Standard"

    INSPECTION_POINTS: List[InspectionCheckItem] = [
        InspectionCheckItem(
            check_id=f"RMA_AUTO-01",
