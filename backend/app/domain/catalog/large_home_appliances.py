"""
Large Major Home Appliances (HOME_MAJOR)
...
class LargeHomeAppliancesCatalog:
    CATEGORY_NAME = "Large Major Home Appliances"
    CATEGORY_PREFIX = "HOME_MAJOR"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-HOME_MAJOR-001": ProductSpecification(
            product_id=f"PROD-HOME_MAJOR-001",
            sku=f"SKU-HOME_MAJOR-PRO-BLK",
            title=f"Flagship Professional Large Major Home Appliances Model Alpha",
        ...
        f"PROD-HOME_MAJOR-002": ProductSpecification(
            product_id=f"PROD-HOME_MAJOR-002",
            sku=f"SKU-HOME_MAJOR-LITE-SLV",
            title=f"Compact Ultra-Portable Large Major Home Appliances Edition",
            brand="Apex Industries",
