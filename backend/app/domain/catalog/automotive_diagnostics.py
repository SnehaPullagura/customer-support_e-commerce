"""
Automotive Electronics & Dashcams (AUTOMOTIVE)
...
class AutomotiveDiagnosticsCatalog:
    CATEGORY_NAME = "Automotive Electronics & Dashcams"
    CATEGORY_PREFIX = "AUTOMOTIVE"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-AUTOMOTIVE-001": ProductSpecification(
            product_id=f"PROD-AUTOMOTIVE-001",
            sku=f"SKU-AUTOMOTIVE-PRO-BLK",
            title=f"Flagship Professional Automotive Electronics & Dashcams Model Alpha",
        ...
        f"PROD-AUTOMOTIVE-002": ProductSpecification(
            product_id=f"PROD-AUTOMOTIVE-002",
            sku=f"SKU-AUTOMOTIVE-LITE-SLV",
            title=f"Compact Ultra-Portable Automotive Electronics & Dashcams Edition",
            brand="Apex Industries",
