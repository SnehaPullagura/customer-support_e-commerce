"""
Fine Timepieces & Luxury Watches (LUXURY_WATCHES)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "LUXURY_WATCHES"
...
class LuxuryTimepiecesCatalog:
    CATEGORY_NAME = "Fine Timepieces & Luxury Watches"
    CATEGORY_PREFIX = "LUXURY_WATCHES"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-LUXURY_WATCHES-001": ProductSpecification(
            product_id=f"PROD-LUXURY_WATCHES-001",
            sku=f"SKU-LUXURY_WATCHES-PRO-BLK",
            title=f"Flagship Professional Fine Timepieces & Luxury Watches Model Alpha",
        ...
        f"PROD-LUXURY_WATCHES-002": ProductSpecification(
            product_id=f"PROD-LUXURY_WATCHES-002",
            sku=f"SKU-LUXURY_WATCHES-LITE-SLV",
            title=f"Compact Ultra-Portable Fine Timepieces & Luxury Watches Edition",
            brand="Apex Industries",
