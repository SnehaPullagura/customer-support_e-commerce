"""
Personal Computing & Laptops (ELEC_COMPUTING)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "ELEC_COMPUTING"
...
class ComputingLaptopsCatalog:
    CATEGORY_NAME = "Personal Computing & Laptops"
    CATEGORY_PREFIX = "ELEC_COMPUTING"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-ELEC_COMPUTING-001": ProductSpecification(
            product_id=f"PROD-ELEC_COMPUTING-001",
            sku=f"SKU-ELEC_COMPUTING-PRO-BLK",
            title=f"Flagship Professional Personal Computing & Laptops Model Alpha",
        ...
        f"PROD-ELEC_COMPUTING-002": ProductSpecification(
            product_id=f"PROD-ELEC_COMPUTING-002",
            sku=f"SKU-ELEC_COMPUTING-LITE-SLV",
            title=f"Compact Ultra-Portable Personal Computing & Laptops Edition",
            brand="Apex Industries",
