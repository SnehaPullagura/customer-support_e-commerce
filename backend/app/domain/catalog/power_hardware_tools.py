"""
Power Tools & Cordless Equipment (HARDWARE_TOOLS)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "HARDWARE_TOOLS"
...
class PowerHardwareToolsCatalog:
    CATEGORY_NAME = "Power Tools & Cordless Equipment"
    CATEGORY_PREFIX = "HARDWARE_TOOLS"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-HARDWARE_TOOLS-001": ProductSpecification(
            product_id=f"PROD-HARDWARE_TOOLS-001",
            sku=f"SKU-HARDWARE_TOOLS-PRO-BLK",
            title=f"Flagship Professional Power Tools & Cordless Equipment Model Alpha",
        ...
        f"PROD-HARDWARE_TOOLS-002": ProductSpecification(
            product_id=f"PROD-HARDWARE_TOOLS-002",
            sku=f"SKU-HARDWARE_TOOLS-LITE-SLV",
            title=f"Compact Ultra-Portable Power Tools & Cordless Equipment Edition",
            brand="Apex Industries",
