"""
1.5ct VVS1 Triple Excellent Diamond Ring Specification (SPEC_JEWELRY)
...
class DiamondSolitaireRing:
    SPEC_CODE = "SPEC_JEWELRY"
    SPEC_TITLE = "1.5ct VVS1 Triple Excellent Diamond Ring Specification"
