"""
Learning Smart Thermostat & Multi-Zone Relay Specification (SPEC_HVAC)
...
class SmartThermostatPro:
    SPEC_CODE = "SPEC_HVAC"
    SPEC_TITLE = "Learning Smart Thermostat & Multi-Zone Relay Specification"
