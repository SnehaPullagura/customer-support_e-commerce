"""
Triple Peptide Ceramide Liposome Night Cream Specification (SPEC_SKIN)
...
class AntiAgingPeptide:
    SPEC_CODE = "SPEC_SKIN"
    SPEC_TITLE = "Triple Peptide Ceramide Liposome Night Cream Specification"
