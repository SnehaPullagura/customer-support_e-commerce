"""
Pro Aerial Drone Telemetry & LiPo Battery Specification (SPEC_DRONE)
...
class DroneProFlight:
    SPEC_CODE = "SPEC_DRONE"
    SPEC_TITLE = "Pro Aerial Drone Telemetry & LiPo Battery Specification"
