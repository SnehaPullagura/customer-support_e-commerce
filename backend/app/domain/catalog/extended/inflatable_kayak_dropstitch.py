"""
Full Drop-Stitch Floor Tandem Inflatable Kayak Specification (SPEC_KAYAK)
...
class InflatableKayakDropstitch:
    SPEC_CODE = "SPEC_KAYAK"
    SPEC_TITLE = "Full Drop-Stitch Floor Tandem Inflatable Kayak Specification"
