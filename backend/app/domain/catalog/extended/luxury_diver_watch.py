"""
300m Titanium Automatic Helium Escape Valve Watch Specification (SPEC_WATCH)
...
class LuxuryDiverWatch:
    SPEC_CODE = "SPEC_WATCH"
    SPEC_TITLE = "300m Titanium Automatic Helium Escape Valve Watch Specification"
