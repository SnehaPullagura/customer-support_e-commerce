"""
Tri-Band Wi-Fi 7 10Gbps Mesh Node Specification (SPEC_ROUTER)
...
class SmartMeshWifi7:
    SPEC_CODE = "SPEC_ROUTER"
    SPEC_TITLE = "Tri-Band Wi-Fi 7 10Gbps Mesh Node Specification"
