"""
Dual Antenna False Alert GPS Lockout Radar Detector Specification (SPEC_RADAR)
...
class RadarDetectorDsp:
    SPEC_CODE = "SPEC_RADAR"
    SPEC_TITLE = "Dual Antenna False Alert GPS Lockout Radar Detector Specification"
