"""
2000W Pure Sine Wave Portable Power Station Specification (SPEC_POWER)
...
class SolarInverterStation:
    SPEC_CODE = "SPEC_POWER"
    SPEC_TITLE = "2000W Pure Sine Wave Portable Power Station Specification"
