"""
USDA Prime 45-Day Dry Aged Tomahawk Steak Box Specification (SPEC_MEAT)
...
class DryAgedTomahawk:
    SPEC_CODE = "SPEC_MEAT"
    SPEC_TITLE = "USDA Prime 45-Day Dry Aged Tomahawk Steak Box Specification"
