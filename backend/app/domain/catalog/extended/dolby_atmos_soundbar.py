"""
Dolby Atmos 11.1.4 Wireless Soundbar Specification (SPEC_AUDIO)
...
class DolbyAtmosSoundbar:
    SPEC_CODE = "SPEC_AUDIO"
    SPEC_TITLE = "Dolby Atmos 11.1.4 Wireless Soundbar Specification"
