"""
60V Max Dual-Blade Cordless Lawn Mower Specification (SPEC_MOWER)
...
class ElectricMower60v:
    SPEC_CODE = "SPEC_MOWER"
    SPEC_TITLE = "60V Max Dual-Blade Cordless Lawn Mower Specification"
