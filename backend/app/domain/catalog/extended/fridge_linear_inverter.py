"""
Four-Door French Door Smart Refrigerator Specification (SPEC_FRIDGE)
...
class FridgeLinearInverter:
    SPEC_CODE = "SPEC_FRIDGE"
    SPEC_TITLE = "Four-Door French Door Smart Refrigerator Specification"
