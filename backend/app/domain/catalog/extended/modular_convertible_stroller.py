"""
All-Terrain Foam-Filled Rubber Tire Stroller Specification (SPEC_BABY)
...
class ModularConvertibleStroller:
    SPEC_CODE = "SPEC_BABY"
    SPEC_TITLE = "All-Terrain Foam-Filled Rubber Tire Stroller Specification"
