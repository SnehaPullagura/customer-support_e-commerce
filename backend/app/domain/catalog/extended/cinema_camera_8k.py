"""
8K Cinema Mirrorless Camera & Global Shutter Specification (SPEC_CINEMA)
...
class CinemaCamera8k:
    SPEC_CODE = "SPEC_CINEMA"
    SPEC_TITLE = "8K Cinema Mirrorless Camera & Global Shutter Specification"
