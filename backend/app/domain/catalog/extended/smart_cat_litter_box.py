"""
Self-Cleaning Health Monitoring Smart Litter Box Specification (SPEC_PET)
...
class SmartCatLitterBox:
    SPEC_CODE = "SPEC_PET"
    SPEC_TITLE = "Self-Cleaning Health Monitoring Smart Litter Box Specification"
