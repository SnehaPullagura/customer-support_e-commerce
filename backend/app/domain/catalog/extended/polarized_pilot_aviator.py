"""
Corrosion Resistant Titanium Aviator Sunglasses Specification (SPEC_OPTICS)
...
class PolarizedPilotAviator:
    SPEC_CODE = "SPEC_OPTICS"
    SPEC_TITLE = "Corrosion Resistant Titanium Aviator Sunglasses Specification"
