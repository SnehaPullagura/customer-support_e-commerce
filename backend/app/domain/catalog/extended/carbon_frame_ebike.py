"""
Carbon Fiber Step-Through Gates Belt Drive E-Bike Specification (SPEC_EBIKE)
...
class CarbonFrameEbike:
    SPEC_CODE = "SPEC_EBIKE"
    SPEC_TITLE = "Carbon Fiber Step-Through Gates Belt Drive E-Bike Specification"
