"""
Full Grain Vegetable Tanned Weekend Duffle Specification (SPEC_LEATHER)
...
class LeatherDuffleBag:
    SPEC_CODE = "SPEC_LEATHER"
    SPEC_TITLE = "Full Grain Vegetable Tanned Weekend Duffle Specification"
