"""
Dual Boiler Commercial Rotary Pump Espresso Specification (SPEC_COFFEE)
...
class EspressoRotaryPump:
    SPEC_CODE = "SPEC_COFFEE"
    SPEC_TITLE = "Dual Boiler Commercial Rotary Pump Espresso Specification"
