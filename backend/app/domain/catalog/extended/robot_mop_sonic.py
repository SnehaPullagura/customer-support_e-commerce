"""
Sonic Mopping & Hot Air Drying Robot Vacuum Specification (SPEC_ROBOT)
...
class RobotMopSonic:
    SPEC_CODE = "SPEC_ROBOT"
    SPEC_TITLE = "Sonic Mopping & Hot Air Drying Robot Vacuum Specification"
