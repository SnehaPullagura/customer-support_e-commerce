"""
Auto-Adjusting Pressure Heated Tubing CPAP Specification (SPEC_CPAP)
...
class AutoTitratingCpap:
    SPEC_CODE = "SPEC_CPAP"
    SPEC_TITLE = "Auto-Adjusting Pressure Heated Tubing CPAP Specification"
