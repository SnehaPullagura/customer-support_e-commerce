"""
Hall Effect Magnetic Switch Rapid Trigger Keyboard Specification (SPEC_KEYBOARD)
...
class MechanicalHallEffect:
    SPEC_CODE = "SPEC_KEYBOARD"
    SPEC_TITLE = "Hall Effect Magnetic Switch Rapid Trigger Keyboard Specification"
