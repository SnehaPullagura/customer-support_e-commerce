"""
Digital Optics & Camera Systems (ELEC_CAMERAS)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "ELEC_CAMERAS"
...
class CamerasImagingCatalog:
    CATEGORY_NAME = "Digital Optics & Camera Systems"
    CATEGORY_PREFIX = "ELEC_CAMERAS"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-ELEC_CAMERAS-001": ProductSpecification(
            product_id=f"PROD-ELEC_CAMERAS-001",
            sku=f"SKU-ELEC_CAMERAS-PRO-BLK",
            title=f"Flagship Professional Digital Optics & Camera Systems Model Alpha",
        ...
        f"PROD-ELEC_CAMERAS-002": ProductSpecification(
            product_id=f"PROD-ELEC_CAMERAS-002",
            sku=f"SKU-ELEC_CAMERAS-LITE-SLV",
            title=f"Compact Ultra-Portable Digital Optics & Camera Systems Edition",
            brand="Apex Industries",
