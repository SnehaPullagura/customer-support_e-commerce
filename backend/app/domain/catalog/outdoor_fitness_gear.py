"""
Outdoor Recreation & Fitness Gear (SPORTS_OUTDOOR)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "SPORTS_OUTDOOR"
...
class OutdoorFitnessGearCatalog:
    CATEGORY_NAME = "Outdoor Recreation & Fitness Gear"
    CATEGORY_PREFIX = "SPORTS_OUTDOOR"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-SPORTS_OUTDOOR-001": ProductSpecification(
            product_id=f"PROD-SPORTS_OUTDOOR-001",
            sku=f"SKU-SPORTS_OUTDOOR-PRO-BLK",
            title=f"Flagship Professional Outdoor Recreation & Fitness Gear Model Alpha",
        ...
        f"PROD-SPORTS_OUTDOOR-002": ProductSpecification(
            product_id=f"PROD-SPORTS_OUTDOOR-002",
            sku=f"SKU-SPORTS_OUTDOOR-LITE-SLV",
            title=f"Compact Ultra-Portable Outdoor Recreation & Fitness Gear Edition",
            brand="Apex Industries",
