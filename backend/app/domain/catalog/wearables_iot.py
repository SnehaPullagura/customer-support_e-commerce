"""
Biometric Wearables & Smart IoT (ELEC_WEARABLES)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "ELEC_WEARABLES"
...
class WearablesIotCatalog:
    CATEGORY_NAME = "Biometric Wearables & Smart IoT"
    CATEGORY_PREFIX = "ELEC_WEARABLES"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-ELEC_WEARABLES-001": ProductSpecification(
            product_id=f"PROD-ELEC_WEARABLES-001",
            sku=f"SKU-ELEC_WEARABLES-PRO-BLK",
            title=f"Flagship Professional Biometric Wearables & Smart IoT Model Alpha",
        ...
        f"PROD-ELEC_WEARABLES-002": ProductSpecification(
            product_id=f"PROD-ELEC_WEARABLES-002",
            sku=f"SKU-ELEC_WEARABLES-LITE-SLV",
            title=f"Compact Ultra-Portable Biometric Wearables & Smart IoT Edition",
            brand="Apex Industries",
