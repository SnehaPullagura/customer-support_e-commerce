"""
Mobile Handsets & Tablets (ELEC_MOBILE)
...
class MobileHandsetsCatalog:
    CATEGORY_NAME = "Mobile Handsets & Tablets"
    CATEGORY_PREFIX = "ELEC_MOBILE"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-ELEC_MOBILE-001": ProductSpecification(
            product_id=f"PROD-ELEC_MOBILE-001",
            sku=f"SKU-ELEC_MOBILE-PRO-BLK",
            title=f"Flagship Professional Mobile Handsets & Tablets Model Alpha",
        ...
        f"PROD-ELEC_MOBILE-002": ProductSpecification(
            product_id=f"PROD-ELEC_MOBILE-002",
            sku=f"SKU-ELEC_MOBILE-LITE-SLV",
            title=f"Compact Ultra-Portable Mobile Handsets & Tablets Edition",
            brand="Apex Industries",
