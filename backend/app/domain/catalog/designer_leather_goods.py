"""
Designer Leather Handbags & Goods (LUXURY_LEATHER)
...
class ProductSpecification(BaseModel):
    ...
    title: str
    brand: str
    category_code: str = "LUXURY_LEATHER"
...
class DesignerLeatherGoodsCatalog:
    CATEGORY_NAME = "Designer Leather Handbags & Goods"
    CATEGORY_PREFIX = "LUXURY_LEATHER"

    PRODUCTS: Dict[str, ProductSpecification] = {
        f"PROD-LUXURY_LEATHER-001": ProductSpecification(
            product_id=f"PROD-LUXURY_LEATHER-001",
            sku=f"SKU-LUXURY_LEATHER-PRO-BLK",
            title=f"Flagship Professional Designer Leather Handbags & Goods Model Alpha",
        ...
        f"PROD-LUXURY_LEATHER-002": ProductSpecification(
            product_id=f"PROD-LUXURY_LEATHER-002",
            sku=f"SKU-LUXURY_LEATHER-LITE-SLV",
            title=f"Compact Ultra-Portable Designer Leather Handbags & Goods Edition",
            brand="Apex Industries",
