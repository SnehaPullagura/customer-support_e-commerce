"""
Home Theater Soundbars & Subwoofers (SOUNDBARS)
...
class AudioSoundbarsPolicy(BaseModel):
    category_code: str = "SOUNDBARS"
    category_title: str = "Home Theater Soundbars & Subwoofers"
