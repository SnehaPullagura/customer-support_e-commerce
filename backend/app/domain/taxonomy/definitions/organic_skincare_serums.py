"""
Cold-Pressed Vitamin C Organic Serums (ORGANIC_SKINCARE)
...
class OrganicSkincareSerumsPolicy(BaseModel):
    category_code: str = "ORGANIC_SKINCARE"
    category_title: str = "Cold-Pressed Vitamin C Organic Serums"
