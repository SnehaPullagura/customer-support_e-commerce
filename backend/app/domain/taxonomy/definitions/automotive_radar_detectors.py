"""
Long-Range DSP Radar Detectors & Cams (RADAR_DETECTORS)
...
class AutomotiveRadarDetectorsPolicy(BaseModel):
    category_code: str = "RADAR_DETECTORS"
    category_title: str = "Long-Range DSP Radar Detectors & Cams"
