"""
Smart Wi-Fi Thermostats & HVAC Relays (THERMOSTATS)
...
class SmartThermostatsPolicy(BaseModel):
    category_code: str = "THERMOSTATS"
    category_title: str = "Smart Wi-Fi Thermostats & HVAC Relays"
