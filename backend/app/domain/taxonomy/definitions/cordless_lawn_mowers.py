"""
Cordless Electric Lawn Mowers & Trimmers (LAWN_CARE)
...
class CordlessLawnMowersPolicy(BaseModel):
    category_code: str = "LAWN_CARE"
    category_title: str = "Cordless Electric Lawn Mowers & Trimmers"
