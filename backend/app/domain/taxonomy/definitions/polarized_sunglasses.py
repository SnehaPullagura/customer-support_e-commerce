"""
Polarized Titanium Frame Sunglasses (SUNGLASSES)
...
class PolarizedSunglassesPolicy(BaseModel):
    category_code: str = "SUNGLASSES"
    category_title: str = "Polarized Titanium Frame Sunglasses"
