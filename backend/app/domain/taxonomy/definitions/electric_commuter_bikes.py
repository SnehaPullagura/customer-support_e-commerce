"""
750W Mid-Drive Electric Commuter Bikes (E_BIKES)
...
class ElectricCommuterBikesPolicy(BaseModel):
    category_code: str = "E_BIKES"
    category_title: str = "750W Mid-Drive Electric Commuter Bikes"
