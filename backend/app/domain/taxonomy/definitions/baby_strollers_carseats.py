"""
Modular Travel Strollers & ISOFIX Seats (BABY_GEAR)
...
class BabyStrollersCarseatsPolicy(BaseModel):
    category_code: str = "BABY_GEAR"
    category_title: str = "Modular Travel Strollers & ISOFIX Seats"
