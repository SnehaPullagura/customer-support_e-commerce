"""
Virtual Reality & Mixed Reality Headsets (VR_HEADSETS)
...
class VrMixedRealityHeadsetsPolicy(BaseModel):
    category_code: str = "VR_HEADSETS"
    category_title: str = "Virtual Reality & Mixed Reality Headsets"
