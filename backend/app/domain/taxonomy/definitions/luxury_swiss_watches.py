"""
Swiss Automatic Chronograph Luxury Watches (LUXURY_WATCHES)
...
class LuxurySwissWatchesPolicy(BaseModel):
    category_code: str = "LUXURY_WATCHES"
    category_title: str = "Swiss Automatic Chronograph Luxury Watches"
