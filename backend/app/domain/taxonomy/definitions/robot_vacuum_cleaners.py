"""
LIDAR Navigation Robot Vacuums & Mops (ROBOT_VACUUMS)
...
class RobotVacuumCleanersPolicy(BaseModel):
    category_code: str = "ROBOT_VACUUMS"
    category_title: str = "LIDAR Navigation Robot Vacuums & Mops"
