"""
Smart French-Door Refrigerators (REFRIGERATORS)
...
class SmartRefrigeratorsPolicy(BaseModel):
    category_code: str = "REFRIGERATORS"
    category_title: str = "Smart French-Door Refrigerators"
