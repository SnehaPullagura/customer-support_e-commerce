"""
18k Solid Gold & Diamond Fine Jewelry (FINE_JEWELRY)
...
class FineGoldJewelryPolicy(BaseModel):
    category_code: str = "FINE_JEWELRY"
    category_title: str = "18k Solid Gold & Diamond Fine Jewelry"
