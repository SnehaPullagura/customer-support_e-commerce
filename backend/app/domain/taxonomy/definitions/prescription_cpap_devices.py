"""
Medical CPAP & Airflow Sleep Monitors (MEDICAL_CPAP)
...
class PrescriptionCpapDevicesPolicy(BaseModel):
    category_code: str = "MEDICAL_CPAP"
    category_title: str = "Medical CPAP & Airflow Sleep Monitors"
