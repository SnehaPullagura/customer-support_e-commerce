"""
Inflatable Military-Grade PVC SUP Boards (PADDLEBOARDS)
...
class StandupPaddleboardsPolicy(BaseModel):
    category_code: str = "PADDLEBOARDS"
    category_title: str = "Inflatable Military-Grade PVC SUP Boards"
