"""
DSLR & Mirrorless Digital Cameras (CAMERAS)
...
class DslrMirrorlessCamerasPolicy(BaseModel):
    category_code: str = "CAMERAS"
    category_title: str = "DSLR & Mirrorless Digital Cameras"
