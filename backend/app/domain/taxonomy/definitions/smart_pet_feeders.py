"""
Automatic Microchip Pet Feeders & Cams (PET_FEEDERS)
...
class SmartPetFeedersPolicy(BaseModel):
    category_code: str = "PET_FEEDERS"
    category_title: str = "Automatic Microchip Pet Feeders & Cams"
