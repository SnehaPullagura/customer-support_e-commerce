"""
Aged Wagyu & Frozen Seafood Boxes (PERISHABLE_MEATS)
...
class PerishableGourmetMeatsPolicy(BaseModel):
    category_code: str = "PERISHABLE_MEATS"
    category_title: str = "Aged Wagyu & Frozen Seafood Boxes"
