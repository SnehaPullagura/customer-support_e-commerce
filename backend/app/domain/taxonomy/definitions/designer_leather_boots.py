"""
Handcrafted Italian Leather Footwear (DESIGNER_SHOES)
...
class DesignerLeatherBootsPolicy(BaseModel):
    category_code: str = "DESIGNER_SHOES"
    category_title: str = "Handcrafted Italian Leather Footwear"
