"""
Ergonomic Lumbar Office Task Chairs (OFFICE_CHAIRS)
...
class ErgonomicOfficeChairsPolicy(BaseModel):
    category_code: str = "OFFICE_CHAIRS"
    category_title: str = "Ergonomic Lumbar Office Task Chairs"
