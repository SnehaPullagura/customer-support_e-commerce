"""
Custom Mechanical Keyboards & Switches (KEYBOARDS)
...
class MechanicalGamingKeyboardsPolicy(BaseModel):
    category_code: str = "KEYBOARDS"
    category_title: str = "Custom Mechanical Keyboards & Switches"
