"""
Portable Battery Stations & Solar Kits (POWER_STATIONS)
...
class PowerStationsPortablePolicy(BaseModel):
    category_code: str = "POWER_STATIONS"
    category_title: str = "Portable Battery Stations & Solar Kits"
