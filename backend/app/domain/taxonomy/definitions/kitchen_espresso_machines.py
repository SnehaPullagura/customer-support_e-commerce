"""
Commercial-Grade Dual Boiler Espresso (ESPRESSO)
...
class KitchenEspressoMachinesPolicy(BaseModel):
    category_code: str = "ESPRESSO"
    category_title: str = "Commercial-Grade Dual Boiler Espresso"
