"""
Consumer Aerial Drones & Quadcopters (DRONES)
...
class ConsumerDronesPolicy(BaseModel):
    category_code: str = "DRONES"
    category_title: str = "Consumer Aerial Drones & Quadcopters"
