"""
Amazon Connect Contact Center CCP Stream Gateway (AMAZON_CONNECT)
...
class VoiceAmazonConnectMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "AMAZON_CONNECT"
    sender_id: str
    recipient_id: str
    content_text: str
...
class VoiceAmazonConnect:
    """Omnichannel transport adapter for Amazon Connect Contact Center CCP Stream Gateway."""
    CHANNEL_CODE = "AMAZON_CONNECT"
    CHANNEL_TITLE = "Amazon Connect Contact Center CCP Stream Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> VoiceAmazonConnectMessagePayload:
        return VoiceAmazonConnectMessagePayload(
