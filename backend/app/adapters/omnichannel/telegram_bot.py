"""
Telegram Bot Support & Bot API Ingestion Gateway (TELEGRAM)
...
class TelegramBotMessagePayload(BaseModel):
    message_id: str
...
class TelegramBot:
    """Omnichannel transport adapter for Telegram Bot Support & Bot API Ingestion Gateway."""
    CHANNEL_CODE = "TELEGRAM"
    CHANNEL_TITLE = "Telegram Bot Support & Bot API Ingestion Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> TelegramBotMessagePayload:
        return TelegramBotMessagePayload(
