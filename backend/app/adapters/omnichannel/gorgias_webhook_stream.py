"""
Gorgias Real-Time Customer Ticket Stream Gateway (GORGIAS_STREAM)
...
class GorgiasWebhookStreamMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "GORGIAS_STREAM"
    sender_id: str
    recipient_id: str
    content_text: str
...
class GorgiasWebhookStream:
    """Omnichannel transport adapter for Gorgias Real-Time Customer Ticket Stream Gateway."""
    CHANNEL_CODE = "GORGIAS_STREAM"
    CHANNEL_TITLE = "Gorgias Real-Time Customer Ticket Stream Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> GorgiasWebhookStreamMessagePayload:
        return GorgiasWebhookStreamMessagePayload(
