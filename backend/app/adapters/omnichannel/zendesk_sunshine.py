"""
Zendesk Sunshine Conversations Webhook Gateway (SUNSHINE)
...
class ZendeskSunshineMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "SUNSHINE"
    sender_id: str
    recipient_id: str
    content_text: str
...
class ZendeskSunshine:
    """Omnichannel transport adapter for Zendesk Sunshine Conversations Webhook Gateway."""
    CHANNEL_CODE = "SUNSHINE"
    CHANNEL_TITLE = "Zendesk Sunshine Conversations Webhook Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> ZendeskSunshineMessagePayload:
        return ZendeskSunshineMessagePayload(
