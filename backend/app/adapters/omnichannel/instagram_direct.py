"""
Instagram Direct Messaging Customer Support Gateway (INSTAGRAM)
...
class InstagramDirectMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "INSTAGRAM"
    sender_id: str
    recipient_id: str
    content_text: str
...
class InstagramDirect:
    """Omnichannel transport adapter for Instagram Direct Messaging Customer Support Gateway."""
    CHANNEL_CODE = "INSTAGRAM"
    CHANNEL_TITLE = "Instagram Direct Messaging Customer Support Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> InstagramDirectMessagePayload:
        return InstagramDirectMessagePayload(
