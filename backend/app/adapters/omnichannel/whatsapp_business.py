"""
WhatsApp Cloud API Business Messaging Gateway (WHATSAPP)
...
class WhatsappBusinessMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "WHATSAPP"
    sender_id: str
    recipient_id: str
    content_text: str
...
class WhatsappBusiness:
    """Omnichannel transport adapter for WhatsApp Cloud API Business Messaging Gateway."""
    CHANNEL_CODE = "WHATSAPP"
    CHANNEL_TITLE = "WhatsApp Cloud API Business Messaging Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> WhatsappBusinessMessagePayload:
        return WhatsappBusinessMessagePayload(
