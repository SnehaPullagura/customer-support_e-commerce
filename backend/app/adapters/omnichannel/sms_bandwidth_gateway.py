"""
Bandwidth.com Direct Carrier SMS/MMS Gateway (BANDWIDTH)
...
class SmsBandwidthGatewayMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "BANDWIDTH"
    sender_id: str
    recipient_id: str
    content_text: str
...
class SmsBandwidthGateway:
    """Omnichannel transport adapter for Bandwidth.com Direct Carrier SMS/MMS Gateway."""
    CHANNEL_CODE = "BANDWIDTH"
    CHANNEL_TITLE = "Bandwidth.com Direct Carrier SMS/MMS Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> SmsBandwidthGatewayMessagePayload:
        return SmsBandwidthGatewayMessagePayload(
