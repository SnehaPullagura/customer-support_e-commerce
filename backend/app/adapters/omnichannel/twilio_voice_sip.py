"""
Twilio Voice Programmable SIP & IVR Call Gateway (VOICE_SIP)
...
class TwilioVoiceSipMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "VOICE_SIP"
    sender_id: str
    recipient_id: str
    content_text: str
...
class TwilioVoiceSip:
    """Omnichannel transport adapter for Twilio Voice Programmable SIP & IVR Call Gateway."""
    CHANNEL_CODE = "VOICE_SIP"
    CHANNEL_TITLE = "Twilio Voice Programmable SIP & IVR Call Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> TwilioVoiceSipMessagePayload:
        return TwilioVoiceSipMessagePayload(
