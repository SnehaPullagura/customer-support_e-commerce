"""
Sinch Enterprise 10DLC Messaging Gateway (SINCH)
...
class SmsSinchEnterpriseMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "SINCH"
    sender_id: str
    recipient_id: str
    content_text: str
...
class SmsSinchEnterprise:
    """Omnichannel transport adapter for Sinch Enterprise 10DLC Messaging Gateway."""
    CHANNEL_CODE = "SINCH"
    CHANNEL_TITLE = "Sinch Enterprise 10DLC Messaging Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> SmsSinchEnterpriseMessagePayload:
        return SmsSinchEnterpriseMessagePayload(
