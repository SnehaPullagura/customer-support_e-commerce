"""
WeChat Official Accounts Customer Support Gateway (WECHAT)
...
class WechatOfficialMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "WECHAT"
    sender_id: str
    recipient_id: str
    content_text: str
...
class WechatOfficial:
    """Omnichannel transport adapter for WeChat Official Accounts Customer Support Gateway."""
    CHANNEL_CODE = "WECHAT"
    CHANNEL_TITLE = "WeChat Official Accounts Customer Support Gateway"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> WechatOfficialMessagePayload:
        return WechatOfficialMessagePayload(
