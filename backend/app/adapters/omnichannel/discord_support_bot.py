"""
Discord Community Support & Private Ticket Bot (DISCORD)
...
class DiscordSupportBotMessagePayload(BaseModel):
    message_id: str
    channel_code: str = "DISCORD"
    sender_id: str
    recipient_id: str
    content_text: str
...
class DiscordSupportBot:
    """Omnichannel transport adapter for Discord Community Support & Private Ticket Bot."""
    CHANNEL_CODE = "DISCORD"
    CHANNEL_TITLE = "Discord Community Support & Private Ticket Bot"
    ...
    async def parse_inbound_webhook(self, raw_json: Dict[str, Any]) -> DiscordSupportBotMessagePayload:
        return DiscordSupportBotMessagePayload(
